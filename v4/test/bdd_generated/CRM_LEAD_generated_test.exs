# Generated by bdd_compiler from /home/wangbo/document/unibo_ex_poc-feat-223/v4/docs/bdd/CRM_LEAD.dsl. DO NOT EDIT.
...
defmodule UniboV4.BDD.Generated.CRM_LEADTest do
  ...
  test "[BDD-CRM_LEAD-SEED-crm_lead_action_lead_lose_update_risk_validation_fail] CRM_LEAD contract seed scenario" do
    ...
    ctx = UniboV4.BDD.Instructions.V1.run_step!(ctx, :when, :when_execute_seed_contract, %{module: "CRM_LEAD"}, %{file: "/home/wangbo/document/unibo_ex_poc-feat-223/v4/docs/bdd/CRM_LEAD.dsl", line: 5, raw: "WHEN when_execute_seed_contract module=\"CRM_LEAD\""}, 5)
    # line 6: THEN then_seed_contract_should_hold module="CRM_LEAD"
    ctx = UniboV4.BDD.Instructions.V1.run_step!(ctx, :then, :then_seed_contract_should_hold, %{module: "CRM_LEAD"}, %{file: "/home/wangbo/document/unibo_ex_poc-feat-223/v4/docs/bdd/CRM_LEAD.dsl", line: 6, raw: "THEN then_seed_contract_should_hold module=\"CRM_LEAD\""}, 6)
    _ctx = ctx
    :ok
  end
