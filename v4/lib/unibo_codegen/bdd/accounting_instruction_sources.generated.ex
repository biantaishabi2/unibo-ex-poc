defmodule UniboV4.Accounting.Accounting.Bdd.InstructionSourcesGenerated do
  @moduledoc false
  ...
  @bdd_instruction %{
    name: :unibo_accounting_budget_action_create,
    kind: :when,
    args: %{
      items: %{type: :string, required?: true, allowed: nil},
    },
  ...
  def __bdd_instruction_unibo_accounting_budget_action_create__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_action_read, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_action_read__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_action_submit, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_action_submit__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_action_approve, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_action_approve__, do: :ok

  @bdd_instruction %{
    name: :unibo_accounting_budget_action_reject,
    kind: :when,
    args: %{
  ...
  def __bdd_instruction_unibo_accounting_budget_action_reject__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_event_approve_accounting_budget_approved, kind: :then, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_event_approve_accounting_budget_approved__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_workflow_budget_approval, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_workflow_budget_approval__, do: :ok

  @bdd_instruction %{
    name: :unibo_accounting_budget_item_action_create,
    kind: :when,
    args: %{
      gl_account_id: %{type: :uuid, required?: false, allowed: nil},
    },
  ...
  def __bdd_instruction_unibo_accounting_budget_item_action_create__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_item_action_update, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_item_action_update__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_budget_item_workflow_budget_item_editing, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_budget_item_workflow_budget_item_editing__, do: :ok
  ...
  @bdd_instruction %{name: :unibo_accounting_user_action_read, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_user_action_read__, do: :ok

  @bdd_instruction %{name: :unibo_accounting_partner_action_read, kind: :when, args: %{}, outputs: %{}, rules: [], scopes: [:integration, :e2e], boundary: :service, async?: false, eventually?: false, assert_class: nil}
  def __bdd_instruction_unibo_accounting_partner_action_read__, do: :ok
