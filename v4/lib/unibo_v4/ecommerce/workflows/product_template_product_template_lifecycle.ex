defmodule UniboV4.Ecommerce.Workflows.ProductTemplate.ProductTemplateLifecycleWorkflow do
  ...
  defp apply_step(record, step, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(ProductTemplate, :create, params), actor: actor)
      :publish ->
      ...
      :discontinue ->
        Ash.update(Ash.Changeset.for_update(record, :discontinue, params), actor: actor)
      :reactivate ->
