defmodule UniboV4.ELearning.Workflows.Enrollment.EnrollmentLifecycleWorkflow do
  ...
  defp apply_step(record, step, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(Enrollment, :create, params), actor: actor)
      :join ->
        Ash.update(Ash.Changeset.for_update(record, :join, params), actor: actor)
      :recompute_completion ->
        Ash.update(Ash.Changeset.for_update(record, :recompute_completion, params), actor: actor)
      :destroy ->
