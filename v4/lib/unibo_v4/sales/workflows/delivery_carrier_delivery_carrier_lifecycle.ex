defmodule UniboV4.Sales.Workflows.DeliveryCarrier.DeliveryCarrierLifecycleWorkflow do
  ...
  defp apply_step(record, step, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(DeliveryCarrier, :create, params), actor: actor)
      :update ->
        Ash.update(Ash.Changeset.for_update(record, :update, params), actor: actor)
      :rate_shipment ->
        Ash.update(Ash.Changeset.for_update(record, :rate_shipment, params), actor: actor)
      :destroy ->
