defmodule UniboV4.DataRecycle.Workflows.RecycleModel.RecycleModelLifecycleWorkflow do
  ...
  defp apply_step(record, step, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(RecycleModel, :create, params), actor: actor)
      :update ->
        Ash.update(Ash.Changeset.for_update(record, :update, params), actor: actor)
      :recycle_records_action ->
        Ash.update(Ash.Changeset.for_update(record, :recycle_records_action, params), actor: actor)
      :cron_recycle ->
        Ash.update(Ash.Changeset.for_update(record, :cron_recycle, params), actor: actor)
      :destroy ->
