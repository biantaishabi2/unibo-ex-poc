...
defmodule UniboV4.Survey.Survey do
  ...
  attributes do
    ...
    attribute :random_questions_count, :integer, public?: true
    ...
    attribute :time_limit, :float, public?: true
    attribute :is_attempts_limited, :boolean do
      default false
      public? true
    end
    attribute :attempts_limit, :integer, public?: true
  ...
  calculations do
    ...
    # TODO: 不支持的 calculation 表达式 :answer_score_avg
    # TODO: 不支持的 calculation 表达式 :success_ratio
    # TODO: 不支持的 calculation 表达式 :answer_duration_avg
    calculate :question_count, :integer, expr(count(questions, query: [filter: expr(true)]))
    # TODO: 不支持的 calculation 表达式 :scoring_max_obtainable
  end
