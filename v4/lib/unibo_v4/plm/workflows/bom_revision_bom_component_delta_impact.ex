  ...
  defp apply_step(record, step, opts) do
    ...
    case step do
      :detect_component_delta ->
        Ash.update(Ash.Changeset.for_update(record, :detect_component_delta, params), actor: actor)
      :sync_procurement_stock_impact ->
        Ash.update(Ash.Changeset.for_update(record, :sync_procurement_stock_impact, params), actor: actor)
      _ -> {:ok, record}
    end
  end
end
