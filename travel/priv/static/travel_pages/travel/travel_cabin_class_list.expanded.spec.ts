  ...
  "setup": [
    {
      ...
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelCabinClass",
      "freshness": "match_only",
      "graphql_field": "listTravelTravelCabinClasses",
...
const __WAIT_CONTRACT = {
  "filter_submit": {
    ...
    "selectors": [
      "#travel_cabin_class_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_cabin_class_list",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_cabin_class_detail",
      "#travel_cabin_class_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_cabin_class_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_cabin_class/new"
    },
    "url_contains": "/pages/travel/travel_cabin_class/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_cabin_class_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_cabin_class/"
    },
    "url_contains": "/pages/travel/travel_cabin_class/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_cabin_class/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_cabin_class_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_cabin_class/"
      },
      {
        "assert": "visible",
        "selector": "#travel_cabin_class_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelCabinClass.list",
  "get": "Travel.TravelCabinClass.get",
  "create": "Travel.TravelCabinClass.create",
  "update": "Travel.TravelCabinClass.update"
};
const __BACKEND_SELECTION = "id cabin_class_code: cabinClassCode cabin_class_name: cabinClassName cabin_rank: cabinRank status";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_cabin_class");
  if (path.includes(':id')) {
...
test.describe("travel_cabin_class_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_cabin_class_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_cabin_class_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_cabin_class/new");
      try {
