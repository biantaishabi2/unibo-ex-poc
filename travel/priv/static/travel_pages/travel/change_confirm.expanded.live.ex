defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "create" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelChangeOrder.create"},
    "list" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelChangeOrder.list"}
  }
