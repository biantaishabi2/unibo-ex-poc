...
const __WAIT_CONTRACT = {
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_policy_detail",
      "#travel_policy_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_policy_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_policy/new"
    },
    "url_contains": "/pages/travel/travel_policy/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_policy_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_policy/"
    },
    "url_contains": "/pages/travel/travel_policy/"
  }
};
const __VERIFICATION_CONTRACT = {
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_policy/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_policy_detail",
  ...
  "row_click": {
    "backend": {
      ...
      "equals": null,
      "excludes_source": null,
      "graphql_field": "getTravelTravelPolicy",
      "op": "exists",
      "path": "id",
      "source": "clicked_row.id"
    },
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_policy/"
      },
      {
        "assert": "visible",
        "selector": "#travel_policy_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelPolicy.list",
  "get": "Travel.TravelPolicy.get",
  "create": "Travel.TravelPolicy.create",
  "update": "Travel.TravelPolicy.update"
};
const __BACKEND_SELECTION = "id policy_name: policyName product_type: productType employee_level: employeeLevel city_tier: cityTier season max_amount: maxAmount cabin_class_limit: cabinClassLimit hotel_star_limit: hotelStarLimit exceed_strategy: exceedStrategy approval_mode: approvalMode personal_pay_ratio: personalPayRatio is_active: isActive enterprise_id: enterpriseId inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_policy");
  if (path.includes(':id')) {
...
test.describe("travel_policy_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_policy_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_policy_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_policy/new");
      try {
