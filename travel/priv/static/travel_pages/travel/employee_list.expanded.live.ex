defmodule UniboExPocWeb.Pages.Travel.EmployeeListLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="employee_list">
