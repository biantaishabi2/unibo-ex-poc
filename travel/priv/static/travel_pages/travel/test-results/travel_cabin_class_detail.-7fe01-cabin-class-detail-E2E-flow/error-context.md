...
- Name: travel_cabin_class_detail.expanded.spec.ts >> travel_cabin_class_detail >> E2E flow
- Location: travel_cabin_class_detail.expanded.spec.ts:863:7

# Error details

```
Error: backend get equals assertion failed: expected inactive got active
```
...
- generic [ref=e2]:
  ...
  - main [ref=e13]:
    - generic "详情" [ref=e15]:
      ...
      - generic [ref=e27]:
        - generic [ref=e29]:
          - paragraph [ref=e30]: TravelCabinClass
          - paragraph [ref=e31]: 舱位主数据（Travel 层,来源 OFBiz Enumeration）
        - generic [ref=e33]:
      ...
      - generic [ref=e37]:
        ...
        - generic [ref=e41]:
          - generic [ref=e43]:
            - textbox [ref=e45]
            - textbox [ref=e47]: UPDATED_1775286437464_jb2ipk_cabin_class_name
            - textbox [ref=e49]: "2"
            - button "inactive" [ref=e51] [cursor=pointer]:
              - generic: inactive
          - generic [ref=e53]:
            - button "取消" [ref=e54] [cursor=pointer]
            - button "保存" [active] [ref=e55] [cursor=pointer]
```
