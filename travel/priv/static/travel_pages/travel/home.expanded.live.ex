defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @impl true
  def handle_event("navigate:/travel", params, socket) do
    # UI action event name: navigate:/travel
    socket = dispatch_backend("navigate:/travel", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/flight/search", params, socket) do
    # UI action event name: navigate:/travel/flight/search
    socket = dispatch_backend("navigate:/travel/flight/search", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/hotel/search", params, socket) do
    # UI action event name: navigate:/travel/hotel/search
    socket = dispatch_backend("navigate:/travel/hotel/search", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/orders", params, socket) do
    # UI action event name: navigate:/travel/orders
    socket = dispatch_backend("navigate:/travel/orders", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/profile", params, socket) do
    # UI action event name: navigate:/travel/profile
    socket = dispatch_backend("navigate:/travel/profile", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/train/search", params, socket) do
    # UI action event name: navigate:/travel/train/search
    socket = dispatch_backend("navigate:/travel/train/search", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("navigate:/travel/trips", params, socket) do
    # UI action event name: navigate:/travel/trips
    socket = dispatch_backend("navigate:/travel/trips", params, socket)
    {:noreply, socket}
  end
