defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): editing, record, record.canonical_entity, record.external_code, record.external_name, record.object_type, record.status, record.supplier_code
  ...
  @backend_api_map %{
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelStaticCodeMapping.get"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelStaticCodeMapping.update"}
  }
