defmodule UniboExPocWeb.Pages.Travel.TravelPolicyDetailLive do
  ...
  @backend_params_accept ["id", "cabin_class_limit", "max_amount", "employee_level", "personal_pay_ratio", "policy_name", "approval_mode", "hotel_star_limit", "exceed_strategy", "city_tier", "enterprise_id", "season", "product_type"]
