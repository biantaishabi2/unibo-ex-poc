defmodule UniboExPocWeb.Pages.Travel.TravelPolicyDetailLive do
  ...
  @backend_params_accept ["id", "approval_mode", "max_amount", "personal_pay_ratio", "hotel_star_limit", "product_type", "cabin_class_limit", "enterprise_id", "policy_name", "employee_level", "city_tier", "season", "exceed_strategy"]
