defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "activate" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicy.activate"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicy.create"},
    "deactivate" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicy.deactivate"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicy.get"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicy.update"}
  }
