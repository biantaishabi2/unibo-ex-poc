...
const __DATA_CONTRACT = {
  ...
  "setup": [
    ...
    },
    {
      ...
      "name": "resolve_original_order_id",
      "owner": "dependent"
    },
    {
      "binds": [
      ...
      "freshness": "match_only",
      "graphql_field": "listTravelTravelChangeOrders",
      "index": 0,
      "kind": "entity_list_first",
      "name": "resolve_current_record",
      "owner": "root",
      "where_equals": "pending",
      "where_path": "status"
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_confirm_change",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_blockers": [],
      "create_graphql_field": "createTravelTravelChangeOrder",
      "create_input": {
        "approval_mode": "none",
        "change_fee": "E2E_{{__run_id}}_change_fee_state_confirm_change_0",
        "change_reason": "E2E_{{__run_id}}_change_reason_state_confirm_change_0",
        "new_offer_id": "E2E_{{__run_id}}_new_offer_id_state_confirm_change_0",
        "original_order_id": "{{original_order_id}}",
        "price_difference": "E2E_{{__run_id}}_price_difference_state_confirm_change_0"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelChangeOrder",
      ...
      "match_keys": [
        {
          "equals": "{{original_order_id}}",
          "path": "original_order_id"
        }
      ],
      "name": "resolve_state_action_record_confirm_change",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_reject_change",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "change_fee": "E2E_{{__run_id}}_change_fee_state_reject_change_1",
        "change_reason": "E2E_{{__run_id}}_change_reason_state_reject_change_1",
        "new_offer_id": "E2E_{{__run_id}}_new_offer_id_state_reject_change_1",
        "original_order_id": "{{original_order_id}}",
        "price_difference": "E2E_{{__run_id}}_price_difference_state_reject_change_1"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelChangeOrder",
      ...
      "name": "resolve_state_action_record_reject_change",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_complete",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "change_fee": "E2E_{{__run_id}}_change_fee_state_complete_0",
        "change_reason": "E2E_{{__run_id}}_change_reason_state_complete_0",
        "new_offer_id": "E2E_{{__run_id}}_new_offer_id_state_complete_0",
        "original_order_id": "{{original_order_id}}",
        "price_difference": "E2E_{{__run_id}}_price_difference_state_complete_0"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelChangeOrder",
      ...
      "name": "resolve_state_action_record_complete",
      "owner": "root",
      "prepare_actions": [
        "confirm_change"
      ],
    ...
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_complete_direct",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "change_fee": "E2E_{{__run_id}}_change_fee_state_complete_direct_2",
        "change_reason": "E2E_{{__run_id}}_change_reason_state_complete_direct_2",
        "new_offer_id": "E2E_{{__run_id}}_new_offer_id_state_complete_direct_2",
        "original_order_id": "{{original_order_id}}",
        "price_difference": "E2E_{{__run_id}}_price_difference_state_complete_direct_2"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelChangeOrder",
      ...
      "name": "resolve_state_action_record_complete_direct",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
...
const __WAIT_CONTRACT = {
  "action": {
    ...
    "selectors": [
      "#travel_change_order_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_change_order_detail",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "destroy": {
    ...
    "selectors": [
      "#travel_change_order_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_change_order_list",
      "state_key": null,
      "url_contains": "/pages/travel/travel_change_order"
    },
    "url_contains": "/pages/travel/travel_change_order"
  },
  "form_submit": {
    ...
    "selectors": [
      "#travel_change_order_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "#travel_change_order_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "form_settled",
      "selector": "#travel_change_order_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
...
const __VERIFICATION_CONTRACT = {
  "action_complete": {
    "backend": {
      ...
      "graphql_field": "getTravelTravelChangeOrder",
      "op": "equals",
      "path": "status",
      "source": "active_record_id"
    },
    ...
    "ui": [
      {
        ...
        "selector": "#travel_change_order_status_badge, #travel_change_order_fcl_status_badge, #state_badge",
        "value": "completed"
      }
    ]
  },
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelChangeOrder.list",
  "get": "Travel.TravelChangeOrder.get",
  "create": "Travel.TravelChangeOrder.create",
  "update": "Travel.TravelChangeOrder.update"
};
const __BACKEND_SELECTION = "id tenant_id: tenantId change_reason: changeReason price_difference: priceDifference change_fee: changeFee new_offer_id: newOfferId status approval_mode: approvalMode inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_change_order/:id");
  if (path.includes(':id')) {
...
test.describe("travel_change_order_detail", () => {
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator(`#travel_change_order_detail`)).toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#travel_change_order_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
      ...
      await expect(page.locator(`#travel_change_order_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).not.toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#travel_change_order_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
        ...
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_change_fee");
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["change_fee"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
      ...
      {
        const loc = page.locator(`#travel_change_order_form_price_difference, [name='price_difference']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_price_difference");
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["price_difference"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
        const loc = page.locator(`#travel_change_order_edit_form button[type="submit"], #travel_change_order_edit_form [phx-click="form_submit"]`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      await test.step("状态转换：pending → approved（confirm_change）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_change_order/{{state_action_record_id_confirm_change}}");
      ...
      await expect(page.locator(`#travel_change_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_change_order_action_confirm_change`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        await captureCreatedRecordId(__ctx, "state", ["action_confirm_change"]);
        await runCaseVerification(page, __ctx, "action_confirm_change", "state", ["action_confirm_change"]);
      });
      await test.step("状态转换：pending → rejected（reject_change）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_change_order/{{state_action_record_id_reject_change}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_change_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_change_order_action_reject_change`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_reject_change"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_reject_change"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_reject_change", ["action_reject_change"]);
        await captureCreatedRecordId(__ctx, "state", ["action_reject_change"]);
        await runCaseVerification(page, __ctx, "action_reject_change", "state", ["action_reject_change"]);
      });
      await test.step("状态转换：approved → completed（complete）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_change_order/{{state_action_record_id_complete}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_change_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_change_order_action_complete`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_complete"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_complete"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_complete", ["action_complete"]);
        await captureCreatedRecordId(__ctx, "state", ["action_complete"]);
        await runCaseVerification(page, __ctx, "action_complete", "state", ["action_complete"]);
      });
      await test.step("状态转换：pending → completed（complete_direct）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_change_order/{{state_action_record_id_complete_direct}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_change_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_change_order_action_complete_direct`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_complete_direct"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_complete_direct"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_complete_direct", ["action_complete_direct"]);
        await captureCreatedRecordId(__ctx, "state", ["action_complete_direct"]);
        await runCaseVerification(page, __ctx, "action_complete_direct", "state", ["action_complete_direct"]);
      });
      await test.step("动作：提交改签申请，如 approval_mode=oa 则通过 integration 创建 ApprovalInstance", async () => {
        await ensureSeedRecord(page, __ctx);
        await page.goto(resolveContractUrl(__ctx));
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      {
        const loc = page.locator(`#travel_change_order_action_submit`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_submit"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_submit"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_submit", ["action_submit"]);
        await captureCreatedRecordId(__ctx, "custom", ["action_submit"]);
        await runCaseVerification(page, __ctx, null, "custom", ["action_submit"]);
      });
    } finally {
