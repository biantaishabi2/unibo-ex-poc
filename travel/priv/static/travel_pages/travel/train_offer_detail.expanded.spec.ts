  ...
  "setup": [
    {
      ...
      "graphql_field": "listTravelTrainOffers",
      "index": 0,
    ...
    },
    {
      ...
      "create_blockers": [],
      "create_graphql_field": "createTravelTrainOffer",
      "create_input": {
        "arrival_at": "2026-01-01T09:00:00Z",
        "arrival_station_code": "E2E_{{__run_id}}_arrival_station_code_state_activate_0",
        "arrival_station_name": "E2E_{{__run_id}}_arrival_station_name_state_activate_0",
        "booking_rules_snapshot": "E2E_{{__run_id}}_booking_rules_snapshot_state_activate_0",
        "change_rules_snapshot": "E2E_{{__run_id}}_change_rules_snapshot_state_activate_0",
        "currency": "E2E_{{__run_id}}_currency_state_activate_0",
        "departure_at": "2026-01-01T09:00:00Z",
        "departure_station_code": "E2E_{{__run_id}}_departure_station_code_state_activate_0",
        "departure_station_name": "E2E_{{__run_id}}_departure_station_name_state_activate_0",
        "host_shop_id": "364028f0-e7d9-40dc-94d2-d5c2e7d1e5d1",
        "inventory_status": "available",
        "is_no_seat": false,
        "listed_price": 1,
        "refund_rules_snapshot": "E2E_{{__run_id}}_refund_rules_snapshot_state_activate_0",
        "sale_status": "draft",
        "seat_class": "E2E_{{__run_id}}_seat_class_state_activate_0",
        "seat_code": "E2E_{{__run_id}}_seat_code_state_activate_0",
        "settlement_price": 1,
        "supplier_code": "E2E_{{__run_id}}_supplier_code_state_activate_0",
        "tenant_id": "f2e5d9c2-e8ca-4ed5-88e2-cae4d5d3cec3",
        "train_no": "E2E_{{__run_id}}_train_no_state_activate_0",
    ...
    },
    {
      ...
      "create_input": {
        "arrival_at": "2026-01-01T09:00:00Z",
        "arrival_station_code": "E2E_{{__run_id}}_arrival_station_code_state_deactivate_0",
        "arrival_station_name": "E2E_{{__run_id}}_arrival_station_name_state_deactivate_0",
        "booking_rules_snapshot": "E2E_{{__run_id}}_booking_rules_snapshot_state_deactivate_0",
        "change_rules_snapshot": "E2E_{{__run_id}}_change_rules_snapshot_state_deactivate_0",
        "currency": "E2E_{{__run_id}}_currency_state_deactivate_0",
        "departure_at": "2026-01-01T09:00:00Z",
        "departure_station_code": "E2E_{{__run_id}}_departure_station_code_state_deactivate_0",
        "departure_station_name": "E2E_{{__run_id}}_departure_station_name_state_deactivate_0",
        "host_shop_id": "383c3d25-4609-40dc-94d2-d8c4d4cbe3d9",
        "inventory_status": "available",
        "is_no_seat": false,
        "listed_price": 1,
        "refund_rules_snapshot": "E2E_{{__run_id}}_refund_rules_snapshot_state_deactivate_0",
        "sale_status": "draft",
        "seat_class": "E2E_{{__run_id}}_seat_class_state_deactivate_0",
        "seat_code": "E2E_{{__run_id}}_seat_code_state_deactivate_0",
        "settlement_price": 1,
        "supplier_code": "E2E_{{__run_id}}_supplier_code_state_deactivate_0",
        "tenant_id": "274409c2-e8ca-4ed8-8acf-c4e2ddd5cad8",
        "train_no": "E2E_{{__run_id}}_train_no_state_deactivate_0",
        "travel_date": "2026-01-01",
        "waitlist_supported": false
      },
      "depends_on": [],
    ...
    },
    {
      ...
      "create_input": {
        "arrival_at": "2026-01-01T09:00:00Z",
        "arrival_station_code": "E2E_{{__run_id}}_arrival_station_code_state_expire_1",
        "arrival_station_name": "E2E_{{__run_id}}_arrival_station_name_state_expire_1",
        "booking_rules_snapshot": "E2E_{{__run_id}}_booking_rules_snapshot_state_expire_1",
        "change_rules_snapshot": "E2E_{{__run_id}}_change_rules_snapshot_state_expire_1",
        "currency": "E2E_{{__run_id}}_currency_state_expire_1",
        "departure_at": "2026-01-01T09:00:00Z",
        "departure_station_code": "E2E_{{__run_id}}_departure_station_code_state_expire_1",
        "departure_station_name": "E2E_{{__run_id}}_departure_station_name_state_expire_1",
        "host_shop_id": "210cc9c0-e7d9-40dc-94d2-d9d7e3d1e1d5",
        "inventory_status": "available",
        "is_no_seat": false,
        "listed_price": 1,
        "refund_rules_snapshot": "E2E_{{__run_id}}_refund_rules_snapshot_state_expire_1",
        "sale_status": "draft",
        "seat_class": "E2E_{{__run_id}}_seat_class_state_expire_1",
        "seat_code": "E2E_{{__run_id}}_seat_code_state_expire_1",
        "settlement_price": 1,
        "supplier_code": "E2E_{{__run_id}}_supplier_code_state_expire_1",
        "tenant_id": "c2e5d9c2-e8ca-4ed9-9dde-cae0d9be9a64",
        "train_no": "E2E_{{__run_id}}_train_no_state_expire_1",
        "travel_date": "2026-01-01",
        "waitlist_supported": false
      },
      "depends_on": [],
...
const __WAIT_CONTRACT = {
  ...
  "destroy": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#train_offer_list",
      "state_key": null,
      "url_contains": "/pages/travel/train_offer"
    },
    "url_contains": "/pages/travel/train_offer"
  },
  "form_submit": {
    ...
    "selectors": [
      "#train_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "#train_offer_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "form_settled",
      "selector": "#train_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
...
const __VERIFICATION_CONTRACT = {
    ...
    "ui": [
      {
        ...
        "selector": "#train_offer_status_badge, #train_offer_fcl_status_badge, #state_badge",
        "value": "active"
      }
    ]
  },
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/train_offer"
      },
      {
        "assert": "visible",
        "selector": "#train_offer_list",
  ...
  "update": {
    "backend": {
      ...
      "binds": [],
      "equals": "$form.departure_station_ref_id",
      "excludes_source": null,
      "graphql_field": "getTravelTrainOffer",
      "op": "equals",
      "path": "departure_station_ref_id",
      "source": "active_record_id"
    },
    "ui": [
      {
...
const __BACKEND_SELECTION = "id tenant_id: tenantId host_shop_id: hostShopId supplier_code: supplierCode train_no: trainNo departure_station_code: departureStationCode departure_station_name: departureStationName arrival_station_code: arrivalStationCode arrival_station_name: arrivalStationName travel_date: travelDate departure_at: departureAt arrival_at: arrivalAt seat_class: seatClass seat_code: seatCode is_no_seat: isNoSeat inventory_status: inventoryStatus waitlist_supported: waitlistSupported listed_price: listedPrice settlement_price: settlementPrice currency booking_rules_snapshot: bookingRulesSnapshot change_rules_snapshot: changeRulesSnapshot refund_rules_snapshot: refundRulesSnapshot sale_status: saleStatus inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/train_offer/:id");
  if (path.includes(':id')) {
...
test.describe("train_offer_detail", () => {
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator(`#train_offer_detail`)).toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#train_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).not.toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#train_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#train_offer_form_listed_price, [name='listed_price']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#train_offer_form_arrival_at, [name='arrival_at']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "2026-02-01T09:00:00Z");
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["arrival_at"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
      ...
      }
      {
        ...
        if (currentChecked !== wantChecked) {
          await loc.click({ timeout: 15000 });
          __ctx.form["is_no_seat"] = wantChecked ? 'true' : 'false'; refreshDataBindings(__ctx);
          await waitForLiveViewReady(page, 15000);
          await syncRouteContext(page, __ctx);
        }
      }
      ...
      }
      {
        ...
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_refund_rules_snapshot");
        await loc.fill(resolvedValue, { timeout: 15000 });
      ...
      }
      {
        ...
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["arrival_station_name"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/train_offer/{{state_action_record_id_activate}}");
      ...
      await expect(page.locator(`#train_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#train_offer_action_activate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/train_offer/{{state_action_record_id_deactivate}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#train_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#train_offer_action_deactivate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/train_offer/{{state_action_record_id_expire}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#train_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#train_offer_action_expire`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/train_offer");
      try {
