defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "actual_amount", "approval_mode", "exceed_amount", "policy_amount", "personal_pay_amount", "exceed_strategy", "exceed_reason", "approval_request_id", "exceed_ratio", "check_result"]
