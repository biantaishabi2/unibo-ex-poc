defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "check_result", "personal_pay_amount", "approval_mode", "exceed_strategy", "exceed_amount", "exceed_reason", "actual_amount", "approval_request_id", "policy_amount", "exceed_ratio"]
