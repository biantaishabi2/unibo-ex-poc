defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "personal_pay_amount", "approval_mode", "policy_amount", "check_result", "actual_amount", "exceed_amount", "exceed_ratio", "exceed_reason", "approval_request_id", "exceed_strategy"]
