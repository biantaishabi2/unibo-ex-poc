defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "exceed_amount", "actual_amount", "approval_request_id", "approval_mode", "exceed_ratio", "exceed_reason", "personal_pay_amount", "policy_amount", "check_result", "exceed_strategy"]
