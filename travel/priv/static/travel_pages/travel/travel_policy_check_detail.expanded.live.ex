defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  @moduledoc """
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "approval_mode", "personal_pay_amount", "exceed_strategy", "actual_amount", "exceed_amount", "policy_amount", "approval_request_id", "exceed_reason", "check_result", "exceed_ratio"]
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="travel_policy_check_detail">
