defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicyCheck.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicyCheck.get"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelPolicyCheck.update"}
  }
