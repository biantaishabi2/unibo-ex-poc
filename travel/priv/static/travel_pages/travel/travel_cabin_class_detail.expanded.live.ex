defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelCabinClass.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelCabinClass.get"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelCabinClass.update"}
  }
