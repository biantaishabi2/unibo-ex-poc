...
const __DATA_CONTRACT = {
  ...
  "setup": [
    ...
    },
    {
      ...
      "create_blockers": [],
      "create_graphql_field": "createTravelHotelOffer",
      "create_input": {
        "cancellation_policy": "E2E_{{__run_id}}_cancellation_policy_state_activate_0",
        "checkin_date": "2026-01-01",
        "checkout_date": "2026-01-01",
        "city_code": "E2E_{{__run_id}}_city_code_state_activate_0",
        "currency": "E2E_{{__run_id}}_currency_state_activate_0",
        "guarantee_policy": "E2E_{{__run_id}}_guarantee_policy_state_activate_0",
        "host_shop_id": "364028f0-e7d9-40dc-94d2-d5c2e7d1e5d1",
        "hotel_code": "E2E_{{__run_id}}_hotel_code_state_activate_0",
        "hotel_name": "E2E_{{__run_id}}_hotel_name_state_activate_0",
        "inventory_count": 1,
        "listed_price": 1,
        "rate_plan_code": "E2E_{{__run_id}}_rate_plan_code_state_activate_0",
        "room_type_code": "E2E_{{__run_id}}_room_type_code_state_activate_0",
        "sale_status": "draft",
        "settlement_price": 1,
    ...
    },
    {
      ...
      "create_graphql_field": "createTravelHotelOffer",
      "create_input": {
        "cancellation_policy": "E2E_{{__run_id}}_cancellation_policy_state_deactivate_0",
        "checkin_date": "2026-01-01",
        "checkout_date": "2026-01-01",
        "city_code": "E2E_{{__run_id}}_city_code_state_deactivate_0",
        "currency": "E2E_{{__run_id}}_currency_state_deactivate_0",
        "guarantee_policy": "E2E_{{__run_id}}_guarantee_policy_state_deactivate_0",
        "host_shop_id": "383c3d25-4609-40dc-94d2-d8c4d4cbe3d9",
        "hotel_code": "E2E_{{__run_id}}_hotel_code_state_deactivate_0",
        "hotel_name": "E2E_{{__run_id}}_hotel_name_state_deactivate_0",
        "inventory_count": 1,
        "listed_price": 1,
        "rate_plan_code": "E2E_{{__run_id}}_rate_plan_code_state_deactivate_0",
        "room_type_code": "E2E_{{__run_id}}_room_type_code_state_deactivate_0",
        "sale_status": "draft",
        "settlement_price": 1,
    ...
    },
    {
      ...
      "create_graphql_field": "createTravelHotelOffer",
      "create_input": {
        "cancellation_policy": "E2E_{{__run_id}}_cancellation_policy_state_expire_1",
        "checkin_date": "2026-01-01",
        "checkout_date": "2026-01-01",
        "city_code": "E2E_{{__run_id}}_city_code_state_expire_1",
        "currency": "E2E_{{__run_id}}_currency_state_expire_1",
        "guarantee_policy": "E2E_{{__run_id}}_guarantee_policy_state_expire_1",
        "host_shop_id": "210cc9c0-e7d9-40dc-94d2-d9d7e3d1e1d5",
        "hotel_code": "E2E_{{__run_id}}_hotel_code_state_expire_1",
        "hotel_name": "E2E_{{__run_id}}_hotel_name_state_expire_1",
        "inventory_count": 1,
        "listed_price": 1,
        "rate_plan_code": "E2E_{{__run_id}}_rate_plan_code_state_expire_1",
        "room_type_code": "E2E_{{__run_id}}_room_type_code_state_expire_1",
        "sale_status": "draft",
        "settlement_price": 1,
...
const __WAIT_CONTRACT = {
  ...
  "destroy": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#hotel_offer_list",
      "state_key": null,
      "url_contains": "/pages/travel/hotel_offer"
    },
    "url_contains": "/pages/travel/hotel_offer"
  },
  "form_submit": {
    ...
    "selectors": [
      "#hotel_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "#hotel_offer_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "form_settled",
      "selector": "#hotel_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
...
const __VERIFICATION_CONTRACT = {
  "action_activate": {
    "backend": {
      ...
      "graphql_field": "getTravelHotelOffer",
      "op": "equals",
      "path": "sale_status",
      "source": "active_record_id"
    },
    ...
    "ui": [
      {
        ...
        "selector": "#hotel_offer_status_badge, #hotel_offer_fcl_status_badge, #state_badge",
        "value": "active"
      }
    ]
  },
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/hotel_offer"
      },
      {
        "assert": "visible",
        "selector": "#hotel_offer_list",
...
const __BACKEND_SELECTION = "id tenant_id: tenantId host_shop_id: hostShopId supplier_code: supplierCode hotel_code: hotelCode hotel_name: hotelName city_code: cityCode room_type_code: roomTypeCode rate_plan_code: ratePlanCode checkin_date: checkinDate checkout_date: checkoutDate listed_price: listedPrice settlement_price: settlementPrice currency inventory_count: inventoryCount cancellation_policy: cancellationPolicy guarantee_policy: guaranteePolicy sale_status: saleStatus inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/hotel_offer/:id");
  if (path.includes(':id')) {
...
test.describe("hotel_offer_detail", () => {
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator(`#hotel_offer_detail`)).toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#hotel_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
      ...
      await expect(page.locator(`#hotel_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).not.toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#hotel_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#hotel_offer_form_cancellation_policy, [name='cancellation_policy']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_hotel_name, [name='hotel_name']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_city_ref_id, [name='city_ref_id']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_city_ref_id");
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["city_ref_id"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
        const loc = page.locator(`#hotel_offer_form_city_code, [name='city_code']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_settlement_price, [name='settlement_price']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_currency, [name='currency']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_inventory_count, [name='inventory_count']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_form_guarantee_policy, [name='guarantee_policy']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_guarantee_policy");
        await loc.fill(resolvedValue, { timeout: 15000 });
        __ctx.form["guarantee_policy"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
        const loc = page.locator(`#hotel_offer_form_listed_price, [name='listed_price']`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "200.00");
        await loc.fill(resolvedValue, { timeout: 15000 });
      ...
      {
        const loc = page.locator(`#hotel_offer_edit_form button[type="submit"], #hotel_offer_edit_form [phx-click="form_submit"]`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/hotel_offer/{{state_action_record_id_activate}}");
      ...
      await expect(page.locator(`#hotel_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#hotel_offer_action_activate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/hotel_offer/{{state_action_record_id_deactivate}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#hotel_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#hotel_offer_action_deactivate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/hotel_offer/{{state_action_record_id_expire}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#hotel_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#hotel_offer_action_expire`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/hotel_offer");
      try {
