defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "settlement_price", "baggage_policy", "sale_status", "seats_available", "fare_family", "host_shop_id", "departure_airport_code", "arrival_airport_code", "listed_price", "currency", "arrival_airport_ref_id", "supplier_code", "arrival_at", "cabin_class", "departure_at", "refund_change_policy", "itinerary_code", "flight_no", "departure_airport_ref_id"]
