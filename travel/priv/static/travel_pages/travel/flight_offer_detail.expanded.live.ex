defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "departure_airport_code", "cabin_class", "seats_available", "departure_at", "currency", "settlement_price", "flight_no", "listed_price", "arrival_airport_ref_id", "arrival_at", "itinerary_code", "departure_airport_ref_id", "fare_family", "baggage_policy", "host_shop_id", "arrival_airport_code", "refund_change_policy", "sale_status", "supplier_code"]
  ...
  @backend_api_map %{
    ...
    "create" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.create"},
    "deactivate" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.deactivate"},
    "destroy" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.destroy"},
    "expire" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.expire"},
    "get" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.get"},
    "update" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.FlightOffer.update"}
  }
  ...
  assigns = assigns
  effects = []
  effects = [%{to: "/pages/travel/flight_offer", type: "navigate"} | effects]
  effects = __interpolate_effects(effects, params)
  %{assigns: assigns, effects: Enum.reverse(effects)}
end
