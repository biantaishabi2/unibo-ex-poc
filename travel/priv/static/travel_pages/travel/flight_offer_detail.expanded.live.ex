defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "currency", "seats_available", "itinerary_code", "departure_airport_code", "departure_airport_ref_id", "supplier_code", "refund_change_policy", "sale_status", "arrival_airport_ref_id", "arrival_airport_code", "flight_no", "fare_family", "baggage_policy", "departure_at", "listed_price", "host_shop_id", "arrival_at", "settlement_price", "cabin_class"]
