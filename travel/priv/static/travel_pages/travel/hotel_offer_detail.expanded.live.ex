defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "cancellation_policy", "inventory_count", "settlement_price", "hotel_code", "listed_price", "city_ref_id", "guarantee_policy", "room_type_code", "sale_status", "hotel_name", "checkin_date", "checkout_date", "supplier_code", "host_shop_id", "currency", "rate_plan_code", "city_code"]
  ...
  @backend_api_map %{
    ...
    "create" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.create"},
    "deactivate" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.deactivate"},
    "destroy" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.destroy"},
    "expire" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.expire"},
    "get" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.get"},
    "update" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.HotelOffer.update"}
  }
  ...
  assigns = assigns
  effects = []
  effects = [%{to: "/pages/travel/hotel_offer", type: "navigate"} | effects]
  effects = __interpolate_effects(effects, params)
  %{assigns: assigns, effects: Enum.reverse(effects)}
end
