defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "hotel_name", "inventory_count", "city_ref_id", "supplier_code", "room_type_code", "hotel_code", "currency", "rate_plan_code", "guarantee_policy", "sale_status", "host_shop_id", "checkin_date", "checkout_date", "settlement_price", "city_code", "listed_price", "cancellation_policy"]
