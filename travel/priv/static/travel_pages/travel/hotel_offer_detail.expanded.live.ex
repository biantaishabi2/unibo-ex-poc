defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "city_code", "supplier_code", "room_type_code", "settlement_price", "guarantee_policy", "cancellation_policy", "host_shop_id", "inventory_count", "checkout_date", "hotel_code", "rate_plan_code", "sale_status", "city_ref_id", "hotel_name", "listed_price", "checkin_date", "currency"]
