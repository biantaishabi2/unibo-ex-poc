defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "room_type_code", "city_ref_id", "sale_status", "settlement_price", "guarantee_policy", "city_code", "cancellation_policy", "checkin_date", "checkout_date", "currency", "listed_price", "hotel_name", "inventory_count", "supplier_code", "hotel_code", "host_shop_id", "rate_plan_code"]
