defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "host_shop_id", "departure_station_code", "train_no", "departure_station_name", "arrival_at", "change_rules_snapshot", "currency", "arrival_station_code", "booking_rules_snapshot", "settlement_price", "refund_rules_snapshot", "arrival_station_ref_id", "sale_status", "travel_date", "departure_at", "waitlist_supported", "listed_price", "seat_class", "supplier_code", "departure_station_ref_id", "seat_code", "is_no_seat", "arrival_station_name", "inventory_status"]
