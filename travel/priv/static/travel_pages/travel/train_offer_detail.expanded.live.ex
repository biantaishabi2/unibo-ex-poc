defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "arrival_station_ref_id", "departure_station_code", "arrival_station_code", "departure_station_ref_id", "arrival_station_name", "settlement_price", "currency", "listed_price", "booking_rules_snapshot", "seat_class", "departure_station_name", "inventory_status", "change_rules_snapshot", "train_no", "seat_code", "departure_at", "arrival_at", "refund_rules_snapshot", "waitlist_supported", "is_no_seat", "sale_status", "supplier_code", "travel_date", "host_shop_id"]
