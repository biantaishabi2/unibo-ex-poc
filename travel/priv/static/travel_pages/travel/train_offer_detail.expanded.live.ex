defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "sale_status", "departure_at", "listed_price", "departure_station_code", "booking_rules_snapshot", "arrival_station_name", "is_no_seat", "train_no", "refund_rules_snapshot", "supplier_code", "travel_date", "change_rules_snapshot", "host_shop_id", "departure_station_ref_id", "arrival_station_ref_id", "seat_code", "settlement_price", "currency", "arrival_station_code", "departure_station_name", "inventory_status", "arrival_at", "seat_class", "waitlist_supported"]
