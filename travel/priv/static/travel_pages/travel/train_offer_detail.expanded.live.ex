defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "booking_rules_snapshot", "arrival_station_code", "arrival_station_ref_id", "departure_at", "seat_code", "is_no_seat", "inventory_status", "waitlist_supported", "currency", "refund_rules_snapshot", "supplier_code", "sale_status", "train_no", "departure_station_name", "departure_station_code", "host_shop_id", "arrival_at", "listed_price", "change_rules_snapshot", "travel_date", "departure_station_ref_id", "arrival_station_name", "seat_class", "settlement_price"]
