defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "arrival_station_name", "seat_code", "is_no_seat", "listed_price", "booking_rules_snapshot", "change_rules_snapshot", "sale_status", "departure_station_name", "arrival_station_ref_id", "inventory_status", "supplier_code", "waitlist_supported", "settlement_price", "travel_date", "departure_at", "currency", "refund_rules_snapshot", "seat_class", "arrival_at", "departure_station_code", "arrival_station_code", "departure_station_ref_id", "host_shop_id", "train_no"]
