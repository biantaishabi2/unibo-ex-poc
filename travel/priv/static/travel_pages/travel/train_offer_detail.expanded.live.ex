defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "change_rules_snapshot", "departure_station_name", "arrival_station_code", "booking_rules_snapshot", "currency", "supplier_code", "refund_rules_snapshot", "departure_station_code", "arrival_station_ref_id", "departure_station_ref_id", "arrival_at", "is_no_seat", "inventory_status", "listed_price", "travel_date", "train_no", "arrival_station_name", "departure_at", "seat_class", "seat_code", "host_shop_id", "waitlist_supported", "settlement_price", "sale_status"]
