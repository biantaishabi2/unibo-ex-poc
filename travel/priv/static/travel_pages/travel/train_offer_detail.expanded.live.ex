defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "seat_class", "settlement_price", "seat_code", "booking_rules_snapshot", "inventory_status", "host_shop_id", "arrival_station_code", "arrival_at", "travel_date", "train_no", "arrival_station_name", "departure_at", "is_no_seat", "departure_station_ref_id", "departure_station_name", "waitlist_supported", "listed_price", "arrival_station_ref_id", "departure_station_code", "currency", "refund_rules_snapshot", "supplier_code", "change_rules_snapshot", "sale_status"]
