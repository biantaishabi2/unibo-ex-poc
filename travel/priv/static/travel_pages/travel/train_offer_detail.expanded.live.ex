defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "departure_station_name", "listed_price", "currency", "change_rules_snapshot", "refund_rules_snapshot", "arrival_at", "departure_station_ref_id", "sale_status", "departure_at", "seat_class", "departure_station_code", "seat_code", "host_shop_id", "arrival_station_name", "arrival_station_ref_id", "supplier_code", "travel_date", "waitlist_supported", "booking_rules_snapshot", "inventory_status", "settlement_price", "arrival_station_code", "is_no_seat", "train_no"]
