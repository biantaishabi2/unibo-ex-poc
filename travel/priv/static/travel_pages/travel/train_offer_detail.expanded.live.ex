defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "settlement_price", "change_rules_snapshot", "refund_rules_snapshot", "booking_rules_snapshot", "departure_station_name", "seat_class", "sale_status", "currency", "waitlist_supported", "departure_station_code", "host_shop_id", "travel_date", "seat_code", "listed_price", "arrival_at", "arrival_station_code", "is_no_seat", "supplier_code", "inventory_status", "train_no", "departure_station_ref_id", "arrival_station_name", "arrival_station_ref_id", "departure_at"]
