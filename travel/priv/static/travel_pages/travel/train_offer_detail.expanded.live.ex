defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "arrival_station_ref_id", "currency", "sale_status", "waitlist_supported", "travel_date", "departure_station_name", "is_no_seat", "booking_rules_snapshot", "change_rules_snapshot", "refund_rules_snapshot", "supplier_code", "host_shop_id", "departure_station_ref_id", "train_no", "arrival_station_name", "arrival_station_code", "departure_station_code", "arrival_at", "departure_at", "seat_class", "seat_code", "inventory_status", "listed_price", "settlement_price"]
