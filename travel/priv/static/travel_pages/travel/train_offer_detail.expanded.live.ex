defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "arrival_at", "booking_rules_snapshot", "currency", "arrival_station_name", "sale_status", "seat_class", "is_no_seat", "arrival_station_ref_id", "travel_date", "waitlist_supported", "train_no", "change_rules_snapshot", "supplier_code", "departure_at", "refund_rules_snapshot", "departure_station_name", "seat_code", "listed_price", "settlement_price", "departure_station_code", "host_shop_id", "departure_station_ref_id", "inventory_status", "arrival_station_code"]
