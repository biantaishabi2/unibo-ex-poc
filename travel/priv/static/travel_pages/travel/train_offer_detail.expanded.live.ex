defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "currency", "supplier_code", "departure_station_name", "arrival_station_ref_id", "arrival_at", "departure_station_code", "departure_station_ref_id", "is_no_seat", "travel_date", "listed_price", "booking_rules_snapshot", "seat_class", "inventory_status", "settlement_price", "host_shop_id", "arrival_station_code", "refund_rules_snapshot", "departure_at", "waitlist_supported", "train_no", "arrival_station_name", "seat_code", "change_rules_snapshot", "sale_status"]
