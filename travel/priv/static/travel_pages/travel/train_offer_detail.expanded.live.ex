defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "arrival_at", "train_no", "departure_station_ref_id", "arrival_station_code", "departure_station_name", "host_shop_id", "departure_at", "seat_code", "is_no_seat", "arrival_station_ref_id", "supplier_code", "listed_price", "arrival_station_name", "waitlist_supported", "travel_date", "settlement_price", "booking_rules_snapshot", "refund_rules_snapshot", "sale_status", "currency", "departure_station_code", "change_rules_snapshot", "inventory_status", "seat_class"]
