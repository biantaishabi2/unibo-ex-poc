defmodule UniboExPocWeb.Pages.Travel.TravelChangeOrderDetailLive do
  ...
  @backend_params_accept ["id", "original_order_id", "change_reason", "new_offer_id", "approval_mode", "price_difference", "change_fee"]
  ...
  assigns = assigns
  effects = []
  effects = [%{type: "navigate", to: "/pages/travel/travel_change_order"} | effects]
  effects = __interpolate_effects(effects, params)
  %{assigns: assigns, effects: Enum.reverse(effects)}
end
