defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "complete" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.complete"},
    "complete_direct" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.complete_direct"},
    "confirm_change" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.confirm_change"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.get"},
    "reject_change" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.reject_change"},
    "submit" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.submit"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelChangeOrder.update"}
  }
