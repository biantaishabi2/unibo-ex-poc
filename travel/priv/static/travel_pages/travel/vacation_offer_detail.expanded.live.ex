defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "listed_price", "settlement_price", "package_type", "destination_ref_id", "cancellation_policy", "departure_city_code", "host_shop_id", "package_name", "inventory_count", "start_date", "departure_city_ref_id", "currency", "sale_status", "supplier_code", "end_date", "package_code", "destination_code", "booking_rules"]
