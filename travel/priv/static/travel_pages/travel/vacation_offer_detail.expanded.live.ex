defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "destination_ref_id", "end_date", "settlement_price", "booking_rules", "package_code", "cancellation_policy", "supplier_code", "inventory_count", "departure_city_code", "departure_city_ref_id", "listed_price", "destination_code", "sale_status", "currency", "start_date", "host_shop_id", "package_name", "package_type"]
