defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "cancellation_policy", "listed_price", "package_code", "departure_city_ref_id", "sale_status", "settlement_price", "departure_city_code", "supplier_code", "currency", "end_date", "package_type", "host_shop_id", "package_name", "destination_code", "inventory_count", "booking_rules", "start_date", "destination_ref_id"]
