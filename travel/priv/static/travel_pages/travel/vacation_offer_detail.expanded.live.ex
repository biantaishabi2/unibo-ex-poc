defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "listed_price", "sale_status", "cancellation_policy", "booking_rules", "departure_city_ref_id", "host_shop_id", "destination_ref_id", "start_date", "end_date", "currency", "supplier_code", "package_type", "inventory_count", "destination_code", "settlement_price", "departure_city_code", "package_code", "package_name"]
