defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_params_accept ["id", "destination_ref_id", "start_date", "booking_rules", "host_shop_id", "cancellation_policy", "inventory_count", "settlement_price", "departure_city_code", "package_name", "departure_city_ref_id", "destination_code", "sale_status", "end_date", "supplier_code", "listed_price", "currency", "package_type", "package_code"]
