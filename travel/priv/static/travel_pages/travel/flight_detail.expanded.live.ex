defmodule UniboExPocWeb.Pages.Travel.FlightDetailLive do
  ...
  @backend_embedded_page %{page_id: "flight_detail", page_kind: "detail", api_map: %{get: "Travel.FlightOffer.get", list: "Travel.FlightOffer.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/flight_detail", query: "", kind: "detail"}, state_schema: %{defaults: %{record: %{sale_status: true}, flight_offer: %{supplier_code: "", itinerary_code: "", flight_no: "", departure_airport_code: "", arrival_airport_code: "", departure_at: "", arrival_at: "", cabin_class: "", fare_family: "", listed_price: "", settlement_price: "", currency: "", seats_available: "", baggage_policy: "", refund_change_policy: "", sale_status: ""}, editing: false}}, status_keys: []}
