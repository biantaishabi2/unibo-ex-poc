defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): page_title, rows, rows[], rows[].airline_code, rows[].airline_name, rows[].iata_code, rows[].icao_code, rows[].status, rows_empty
  ...
  @backend_api_map %{
    "list" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelAirline.list"}
  }
