defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): editing, record, record.boarding_status, record.change_result, record.confirmation_payload, record.failure_reason, record.fulfillment_type, record.status, record.supplier_booking_ref, record.ticket_refs, record.used_at, record.voucher_or_ticket_ref, record.waitlist_result
