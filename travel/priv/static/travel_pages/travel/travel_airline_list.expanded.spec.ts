  ...
  "setup": [
    {
      ...
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelAirline",
      "freshness": "match_only",
      "graphql_field": "listTravelTravelAirlines",
...
const __WAIT_CONTRACT = {
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_airline_detail",
      "#travel_airline_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_airline_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_airline/new"
    },
    "url_contains": "/pages/travel/travel_airline/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_airline_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_airline/"
    },
    "url_contains": "/pages/travel/travel_airline/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_airline/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_airline_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_airline/"
      },
      {
        "assert": "visible",
        "selector": "#travel_airline_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelAirline.list",
  "get": "Travel.TravelAirline.get",
  "create": "Travel.TravelAirline.create",
  "update": "Travel.TravelAirline.update"
};
const __BACKEND_SELECTION = "id airline_code: airlineCode airline_name: airlineName iata_code: iataCode icao_code: icaoCode status";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_airline");
  if (path.includes(':id')) {
...
test.describe("travel_airline_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_airline_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_airline_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_airline/new");
      try {
