defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): page_title, rows, rows[], rows[].bed_type, rows[].hotel_code, rows[].room_type_code, rows[].room_type_name, rows[].status, rows_empty
  ...
  @backend_api_map %{
    "list" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRoomType.list"}
  }
