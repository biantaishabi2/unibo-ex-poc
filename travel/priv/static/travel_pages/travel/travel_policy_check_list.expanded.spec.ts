...
const __DATA_CONTRACT = {
  ...
  "setup": [
    ...
    },
    {
      ...
      "entity": "TravelPolicy",
      "freshness": "match_only",
      "graphql_field": "listTravelTravelPolicies",
      "kind": "related_list_first",
    ...
    },
    {
      ...
      "freshness": "match_only",
      "graphql_field": "listTravelTravelPolicyChecks",
...
const __WAIT_CONTRACT = {
  "filter_submit": {
    ...
    "selectors": [
      "#travel_policy_check_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_policy_check_list",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_policy_check_detail",
      "#travel_policy_check_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_policy_check_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_policy_check/new"
    },
    "url_contains": "/pages/travel/travel_policy_check/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_policy_check_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_policy_check/"
    },
    "url_contains": "/pages/travel/travel_policy_check/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_policy_check/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_policy_check_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_policy_check/"
      },
      {
        "assert": "visible",
        "selector": "#travel_policy_check_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelPolicyCheck.list",
  "get": "Travel.TravelPolicyCheck.get",
  "create": "Travel.TravelPolicyCheck.create",
  "update": "Travel.TravelPolicyCheck.update"
};
const __BACKEND_SELECTION = "id check_result: checkResult policy_amount: policyAmount actual_amount: actualAmount exceed_amount: exceedAmount exceed_ratio: exceedRatio exceed_strategy: exceedStrategy exceed_reason: exceedReason personal_pay_amount: personalPayAmount approval_request_id: approvalRequestId approval_mode: approvalMode inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_policy_check");
  if (path.includes(':id')) {
...
test.describe("travel_policy_check_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_policy_check_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_policy_check_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_policy_check/new");
      try {
