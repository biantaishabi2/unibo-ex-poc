defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): rows, rows[], rows[].approval_mode, rows[].refund_amount, rows[].refund_fee, rows[].refund_reason, rows[].status, rows_empty, travel_refund_order, travel_refund_order.page, travel_refund_order.total_pages
  ...
  @backend_api_map %{
    "list" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.list"}
  }
