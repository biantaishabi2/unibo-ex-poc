defmodule UniboExPocWeb.Pages.Travel.OaIntegrationConfigLive do
  @moduledoc """
  ...
  @page_id "oa_integration_config"
  @page_title "Untitled Page"

  # status.keys preview (first ~40): record, record.logo, record.notify_frequency, record.notify_method, record.password_policy, record.session_timeout, record.site_description, record.site_name, record.status
  ...
  @backend_embedded_page %{page_id: "oa_integration_config", page_kind: "detail", api_map: %{get: "Travel.TravelOrder.get", list: "Travel.TravelOrder.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/oa_integration_config", query: "", kind: "detail"}, state_schema: %{defaults: %{record: %{status: true, site_name: "", logo: "", site_description: "", notify_method: "", notify_frequency: "", session_timeout: "", password_policy: ""}}}, status_keys: []}
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="oa_integration_config">
