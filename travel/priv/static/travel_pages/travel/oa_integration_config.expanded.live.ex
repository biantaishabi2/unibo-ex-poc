defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "get" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelOrder.get"},
    "list" => %{module: MyAppWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelOrder.list"}
  }
