defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): editing, record, record.approval_mode, record.refund_amount, record.refund_fee, record.refund_reason, record.status
  ...
  @backend_api_map %{
    "confirm_refund" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.confirm_refund"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.get"},
    "refund" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.refund"},
    "refund_direct" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.refund_direct"},
    "reject_refund" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.reject_refund"},
    "submit" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.submit"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelRefundOrder.update"}
  }
