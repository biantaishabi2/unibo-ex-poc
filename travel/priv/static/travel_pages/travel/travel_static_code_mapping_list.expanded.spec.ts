  ...
  "setup": [
    {
      ...
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelStaticCodeMapping",
      "freshness": "match_only",
      "graphql_field": "listTravelTravelStaticCodeMappings",
...
const __WAIT_CONTRACT = {
  "filter_submit": {
    ...
    "selectors": [
      "#travel_static_code_mapping_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_static_code_mapping_list",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_static_code_mapping_detail",
      "#travel_static_code_mapping_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_static_code_mapping_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_static_code_mapping/new"
    },
    "url_contains": "/pages/travel/travel_static_code_mapping/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_static_code_mapping_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_static_code_mapping/"
    },
    "url_contains": "/pages/travel/travel_static_code_mapping/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_static_code_mapping/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_static_code_mapping_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_static_code_mapping/"
      },
      {
        "assert": "visible",
        "selector": "#travel_static_code_mapping_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelStaticCodeMapping.list",
  "get": "Travel.TravelStaticCodeMapping.get",
  "create": "Travel.TravelStaticCodeMapping.create",
  "update": "Travel.TravelStaticCodeMapping.update"
};
const __BACKEND_SELECTION = "id supplier_code: supplierCode object_type: objectType canonical_entity: canonicalEntity canonical_id: canonicalId external_code: externalCode external_name: externalName status";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_static_code_mapping");
  if (path.includes(':id')) {
...
test.describe("travel_static_code_mapping_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_static_code_mapping_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_static_code_mapping_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_static_code_mapping/new");
      try {
