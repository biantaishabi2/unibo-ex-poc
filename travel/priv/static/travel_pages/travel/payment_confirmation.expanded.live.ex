defmodule UniboExPocWeb.Pages.Travel.PaymentConfirmationLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="payment_confirmation">
