  ...
  "setup": [
    {
      ...
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelRoomType",
      "freshness": "match_only",
      "graphql_field": "listTravelTravelRoomTypes",
...
const __WAIT_CONTRACT = {
  "filter_submit": {
    ...
    "selectors": [
      "#travel_room_type_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_room_type_list",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "navigate_create": {
    ...
    "reload_messages": [],
    "selectors": [
      "#travel_room_type_detail",
      "#travel_room_type_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_room_type_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_room_type/new"
    },
    "url_contains": "/pages/travel/travel_room_type/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_room_type_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_room_type/"
    },
    "url_contains": "/pages/travel/travel_room_type/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_room_type/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_room_type_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_room_type/"
      },
      {
        "assert": "visible",
        "selector": "#travel_room_type_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelRoomType.list",
  "get": "Travel.TravelRoomType.get",
  "create": "Travel.TravelRoomType.create",
  "update": "Travel.TravelRoomType.update"
};
const __BACKEND_SELECTION = "id room_type_code: roomTypeCode room_type_name: roomTypeName hotel_code: hotelCode bed_type: bedType status";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_room_type");
  if (path.includes(':id')) {
...
test.describe("travel_room_type_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_room_type_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_room_type_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_room_type/new");
      try {
