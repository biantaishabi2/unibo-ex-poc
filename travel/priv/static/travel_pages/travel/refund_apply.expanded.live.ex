defmodule UniboExPocWeb.Pages.Travel.RefundApplyLive do
  ...
  @backend_embedded_page %{page_id: "refund_apply", page_kind: "detail", api_map: %{create: "Travel.TravelRefundOrder.create", list: "Travel.TravelRefundOrder.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/refund_apply", query: "", kind: "detail"}, state_schema: %{defaults: %{section_1_title: "基本信息"}}, status_keys: []}
