defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): editing, record, record.airline_code, record.airline_name, record.iata_code, record.icao_code, record.status
  ...
  @backend_api_map %{
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "Travel.TravelAirline.create"},
