defmodule UniboExPocWeb.Pages.Travel.TravelHotelDetailLive do
  ...
  @backend_params_accept ["id", "status", "city_id", "city_code", "hotel_code", "hotel_star", "hotel_name"]
  ...
  @backend_embedded_page %{page_id: "travel_hotel_detail", page_kind: "detail", api_map: %{create: "Travel.TravelHotel.create", get: "Travel.TravelHotel.get", update: "Travel.TravelHotel.update"}, backend: %{load: %{selection: "city_code: cityCode hotel_code: hotelCode hotel_name: hotelName hotel_star: hotelStar id status"}}, route: %{path: "/pages/travel/travel_hotel/:id", query: "", kind: "detail"}, state_schema: %{defaults: %{travel_hotel: %{hotel_code: "", hotel_name: "", city_code: "", hotel_star: "", status: ""}, editing: false}}, status_keys: ["record", "editing", "form", "loading"]}
