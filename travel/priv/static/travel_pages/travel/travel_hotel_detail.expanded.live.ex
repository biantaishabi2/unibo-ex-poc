defmodule UniboExPocWeb.Pages.Travel.TravelHotelDetailLive do
  ...
  @backend_params_accept ["id", "hotel_name", "status", "hotel_code", "city_code", "city_id", "hotel_star"]
  ...
  @input_allowlist %{"create" => ~w(hotel_code hotel_name city_id city_code hotel_star status), "update" => ~w(hotel_name city_id city_code hotel_star status)}
