...
const __DATA_CONTRACT = {
  ...
  "setup": [
    ...
    },
    {
      ...
      "freshness": "match_only",
      "graphql_field": "listTravelTravelRefundOrders",
      "index": 0,
    ...
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_confirm_refund",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_blockers": [],
      "create_graphql_field": "createTravelTravelRefundOrder",
      "create_input": {
        "approval_mode": "none",
        "original_order_id": "{{original_order_id}}",
        "refund_amount": "E2E_{{__run_id}}_refund_amount_state_confirm_refund_0",
        "refund_fee": "E2E_{{__run_id}}_refund_fee_state_confirm_refund_0",
        "refund_reason": "E2E_{{__run_id}}_refund_reason_state_confirm_refund_0"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelRefundOrder",
      ...
      "name": "resolve_state_action_record_confirm_refund",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_reject_refund",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "original_order_id": "{{original_order_id}}",
        "refund_amount": "E2E_{{__run_id}}_refund_amount_state_reject_refund_1",
        "refund_fee": "E2E_{{__run_id}}_refund_fee_state_reject_refund_1",
        "refund_reason": "E2E_{{__run_id}}_refund_reason_state_reject_refund_1"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelRefundOrder",
      ...
      "name": "resolve_state_action_record_reject_refund",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_refund",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "original_order_id": "{{original_order_id}}",
        "refund_amount": "E2E_{{__run_id}}_refund_amount_state_refund_0",
        "refund_fee": "E2E_{{__run_id}}_refund_fee_state_refund_0",
        "refund_reason": "E2E_{{__run_id}}_refund_reason_state_refund_0"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelRefundOrder",
      ...
      "name": "resolve_state_action_record_refund",
      "owner": "root",
      "prepare_actions": [
        "confirm_refund"
      ],
    ...
    },
    {
      "binds": [
        {
          "name": "state_action_record_id_refund_direct",
          "path": "id",
          "source": "result"
        }
      ],
      ...
      "create_input": {
        "approval_mode": "none",
        "original_order_id": "{{original_order_id}}",
        "refund_amount": "E2E_{{__run_id}}_refund_amount_state_refund_direct_2",
        "refund_fee": "E2E_{{__run_id}}_refund_fee_state_refund_direct_2",
        "refund_reason": "E2E_{{__run_id}}_refund_reason_state_refund_direct_2"
      },
      "depends_on": [],
      "domain": "Travel",
      "entity": "TravelRefundOrder",
      ...
      "name": "resolve_state_action_record_refund_direct",
      "owner": "root",
      "prepare_actions": [],
      "where_equals": "pending",
      "where_path": "status"
...
const __WAIT_CONTRACT = {
  "action": {
    ...
    "selectors": [
      "#travel_refund_order_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#travel_refund_order_detail",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "destroy": {
    ...
    "selectors": [
      "#travel_refund_order_list"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_refund_order_list",
      "state_key": null,
      "url_contains": "/pages/travel/travel_refund_order"
    },
    "url_contains": "/pages/travel/travel_refund_order"
  },
  "form_submit": {
    ...
    "selectors": [
      "#travel_refund_order_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "#travel_refund_order_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "form_settled",
      "selector": "#travel_refund_order_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
...
const __VERIFICATION_CONTRACT = {
  "action_confirm_refund": {
    "backend": {
      ...
      "graphql_field": "getTravelTravelRefundOrder",
      "op": "equals",
      "path": "status",
      "source": "active_record_id"
    },
    ...
    "ui": [
      {
        ...
        "selector": "#travel_refund_order_status_badge, #travel_refund_order_fcl_status_badge, #state_badge",
        "value": "approved"
      }
    ]
  },
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelRefundOrder.list",
  "get": "Travel.TravelRefundOrder.get",
  "create": "Travel.TravelRefundOrder.create",
  "update": "Travel.TravelRefundOrder.update"
};
const __BACKEND_SELECTION = "id refund_reason: refundReason refund_fee: refundFee refund_amount: refundAmount status approval_mode: approvalMode inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_refund_order/:id");
  if (path.includes(':id')) {
...
test.describe("travel_refund_order_detail", () => {
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator(`#travel_refund_order_detail`)).toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#travel_refund_order_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).not.toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#travel_refund_order_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).toBeVisible({ timeout: 15000 });
      {
        ...
        __ctx.form["refund_fee"] = resolvedValue; refreshDataBindings(__ctx);
      }
      {
      ...
      await test.step("状态转换：pending → approved（confirm_refund）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_refund_order/{{state_action_record_id_confirm_refund}}");
      ...
      await expect(page.locator(`#travel_refund_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_refund_order_action_confirm_refund`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_confirm_refund"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_confirm_refund"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_confirm_refund", ["action_confirm_refund"]);
        await captureCreatedRecordId(__ctx, "state", ["action_confirm_refund"]);
        await runCaseVerification(page, __ctx, "action_confirm_refund", "state", ["action_confirm_refund"]);
      });
      await test.step("状态转换：pending → rejected（reject_refund）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_refund_order/{{state_action_record_id_reject_refund}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_refund_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_refund_order_action_reject_refund`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_reject_refund"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_reject_refund"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_reject_refund", ["action_reject_refund"]);
        await captureCreatedRecordId(__ctx, "state", ["action_reject_refund"]);
        await runCaseVerification(page, __ctx, "action_reject_refund", "state", ["action_reject_refund"]);
      });
      await test.step("状态转换：approved → refunded（refund）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_refund_order/{{state_action_record_id_refund}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_refund_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_refund_order_action_refund`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_refund"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_refund"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_refund", ["action_refund"]);
        await captureCreatedRecordId(__ctx, "state", ["action_refund"]);
        await runCaseVerification(page, __ctx, "action_refund", "state", ["action_refund"]);
      });
      await test.step("状态转换：pending → refunded（refund_direct）", async () => {
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/travel_refund_order/{{state_action_record_id_refund_direct}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#travel_refund_order_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#travel_refund_order_action_refund_direct`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
        ...
        if (clickedId) {
          __ctx.clicked_row = { ...( __ctx.clicked_row || {}), id: clickedId };
          __ctx["state_action_record_id_refund_direct"] = clickedId;
          refreshDataBindings(__ctx);
        }
        if (!clickedId) {
          __ctx["state_action_record_id_refund_direct"] = defaultRecordId(__ctx);
        }
        await waitForLiveViewReady(page, 15000);
        await syncRouteContext(page, __ctx);
      }
        await runCaseWait(page, __ctx, "action_refund_direct", ["action_refund_direct"]);
        await captureCreatedRecordId(__ctx, "state", ["action_refund_direct"]);
        await runCaseVerification(page, __ctx, "action_refund_direct", "state", ["action_refund_direct"]);
      });
      await test.step("动作：提交退票申请，如 approval_mode=oa 则通过 integration 创建 ApprovalInstance", async () => {
        await ensureSeedRecord(page, __ctx);
        await page.goto(resolveContractUrl(__ctx));
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      {
        const loc = page.locator(`#travel_refund_order_action_submit`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
