  ...
  "setup": [
    {
      ...
      "graphql_field": "listTravelTravelHotels",
...
const __WAIT_CONTRACT = {
  ...
  "navigate_create": {
    ...
    "selectors": [
      "#travel_hotel_detail",
      "#travel_hotel_edit_form, #main_form, form[phx-submit=\"form_submit\"]"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "url_contains",
      "selector": "#travel_hotel_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": "/pages/travel/travel_hotel/new"
    },
    "url_contains": "/pages/travel/travel_hotel/new"
  },
  "refetch": {
  ...
  "row_click": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#travel_hotel_detail",
      "state_key": null,
      "url_contains": "/pages/travel/travel_hotel/"
    },
    "url_contains": "/pages/travel/travel_hotel/"
  }
};
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_hotel/new"
      },
      {
        "assert": "visible",
        "selector": "#travel_hotel_detail",
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/travel_hotel/"
      },
      {
        "assert": "visible",
        "selector": "#travel_hotel_detail",
...
const __BACKEND_API_MAP = {
  "list": "Travel.TravelHotel.list",
  "get": "Travel.TravelHotel.get",
  "create": "Travel.TravelHotel.create",
  "update": "Travel.TravelHotel.update"
};
const __BACKEND_SELECTION = "id hotel_code: hotelCode hotel_name: hotelName city_code: cityCode hotel_star: hotelStar status";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/travel_hotel");
  if (path.includes(':id')) {
...
test.describe("travel_hotel_list", () => {
  ...
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await test.step("页面加载 + 结构可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_hotel_list`)).toBeVisible({ timeout: 15000 });
      ...
      await test.step("表格区域可见", async () => {
        ...
        await syncRouteContext(page, __ctx);
        await waitForLiveViewReady(page, 15000);
      await expect(page.locator(`#travel_hotel_table, #table_section, table`).first()).toBeVisible({ timeout: 15000 });
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/travel_hotel/new");
      try {
