defmodule UniboExPocWeb.Pages.Travel.TravelOrderDetailLive do
  ...
  @backend_params_accept ["id", "hotel_offer_id", "total_amount", "contact_phone", "ticket_passenger_infos", "traveler_count", "contact_name", "product_type", "host_shop_id", "order_no", "customer_id", "points_to_use", "seat_selection_snapshot", "points_deduction_amount", "currency"]
