  ...
  "setup": [
    {
      ...
      "depends_on": [],
      "domain": "Travel",
      "entity": "VacationOffer",
      "freshness": "match_only",
      "graphql_field": "listTravelVacationOffers",
      "index": 0,
    ...
    },
    {
      ...
      "create_blockers": [],
      "create_graphql_field": "createTravelVacationOffer",
      "create_input": {
        "booking_rules": "E2E_{{__run_id}}_booking_rules_state_activate_0",
        "cancellation_policy": "E2E_{{__run_id}}_cancellation_policy_state_activate_0",
        "currency": "E2E_{{__run_id}}_currency_state_activate_0",
        "departure_city_code": "E2E_{{__run_id}}_departure_city_code_state_activate_0",
        "destination_code": "E2E_{{__run_id}}_destination_code_state_activate_0",
        "end_date": "2026-01-02",
        "host_shop_id": "364028f0-e7d9-40dc-94d2-d5c2e7d1e5d1",
        "inventory_count": 1,
        "listed_price": 1,
        "package_code": "E2E_{{__run_id}}_package_code_state_activate_0",
        "package_name": "E2E_{{__run_id}}_package_name_state_activate_0",
    ...
    },
    {
      ...
      "create_graphql_field": "createTravelVacationOffer",
      "create_input": {
        "booking_rules": "E2E_{{__run_id}}_booking_rules_state_deactivate_0",
        ...
        "departure_city_code": "E2E_{{__run_id}}_departure_city_code_state_deactivate_0",
        "destination_code": "E2E_{{__run_id}}_destination_code_state_deactivate_0",
        "end_date": "2026-01-02",
        "host_shop_id": "383c3d25-4609-40dc-94d2-d8c4d4cbe3d9",
        "inventory_count": 1,
        "listed_price": 1,
        "package_code": "E2E_{{__run_id}}_package_code_state_deactivate_0",
        "package_name": "E2E_{{__run_id}}_package_name_state_deactivate_0",
        "package_type": "group_tour",
        "sale_status": "draft",
        "settlement_price": 1,
        "start_date": "2026-01-01",
    ...
    },
    {
      ...
      "create_graphql_field": "createTravelVacationOffer",
      "create_input": {
        "booking_rules": "E2E_{{__run_id}}_booking_rules_state_expire_1",
        "cancellation_policy": "E2E_{{__run_id}}_cancellation_policy_state_expire_1",
        "currency": "E2E_{{__run_id}}_currency_state_expire_1",
        "departure_city_code": "E2E_{{__run_id}}_departure_city_code_state_expire_1",
        "destination_code": "E2E_{{__run_id}}_destination_code_state_expire_1",
        "end_date": "2026-01-02",
        "host_shop_id": "210cc9c0-e7d9-40dc-94d2-d9d7e3d1e1d5",
        "inventory_count": 1,
        "listed_price": 1,
        "package_code": "E2E_{{__run_id}}_package_code_state_expire_1",
        "package_name": "E2E_{{__run_id}}_package_name_state_expire_1",
        "package_type": "group_tour",
        "sale_status": "draft",
        "settlement_price": 1,
        "start_date": "2026-01-01",
...
const __WAIT_CONTRACT = {
  "action": {
    ...
    "selectors": [
      "#vacation_offer_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "visible",
      "selector": "#vacation_offer_detail",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
  ...
  "destroy": {
    ...
    "until": {
      "kind": "url_contains",
      "selector": "#vacation_offer_list",
      "state_key": null,
      "url_contains": "/pages/travel/vacation_offer"
    },
    "url_contains": "/pages/travel/vacation_offer"
  },
  "form_submit": {
    ...
    "selectors": [
      "#vacation_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "#vacation_offer_detail"
    ],
    "state_keys": [],
    "timeout": 8000,
    "until": {
      "kind": "form_settled",
      "selector": "#vacation_offer_edit_form, #main_form, form[phx-submit=\"form_submit\"]",
      "state_key": null,
      "url_contains": null
    },
    "url_contains": null
...
const __VERIFICATION_CONTRACT = {
    ...
    "ui": [
      {
        ...
        "selector": "#vacation_offer_status_badge, #vacation_offer_fcl_status_badge, #state_badge",
        "value": "active"
      }
    ]
  },
    ...
    "ui": [
      {
        "assert": "url_contains",
        "selector": null,
        "value": "/pages/travel/vacation_offer"
      },
      {
        "assert": "visible",
        "selector": "#vacation_offer_list",
  ...
  "update": {
    "backend": {
      ...
      "binds": [],
      "equals": "$form.destination_ref_id",
      "excludes_source": null,
      "graphql_field": "getTravelVacationOffer",
      "op": "equals",
      "path": "destination_ref_id",
      "source": "active_record_id"
    },
    "ui": [
      {
...
const __BACKEND_API_MAP = {
  "list": "Travel.VacationOffer.list",
  "get": "Travel.VacationOffer.get",
  "create": "Travel.VacationOffer.create",
  "update": "Travel.VacationOffer.update",
  "destroy": "Travel.VacationOffer.destroy"
};
const __BACKEND_SELECTION = "id tenant_id: tenantId host_shop_id: hostShopId supplier_code: supplierCode package_code: packageCode package_name: packageName package_type: packageType departure_city_code: departureCityCode destination_code: destinationCode start_date: startDate end_date: endDate listed_price: listedPrice settlement_price: settlementPrice currency inventory_count: inventoryCount booking_rules: bookingRules cancellation_policy: cancellationPolicy sale_status: saleStatus inserted_at: insertedAt updated_at: updatedAt";
...
function resolveContractUrl(ctx) {
  let path = resolveTemplateString(ctx, "/pages/travel/vacation_offer/:id");
  if (path.includes(':id')) {
...
test.describe("vacation_offer_detail", () => {
  test('E2E flow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator(`#vacation_offer_detail`)).toBeVisible({ timeout: 15000 });
      ...
      await expect(page.locator(`#vacation_offer_edit_form, #main_form, form[phx-submit="form_submit"]`).first()).not.toBeVisible({ timeout: 15000 });
      ...
      }
      {
        ...
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const resolvedValue = resolveTemplateString(__ctx, "UPDATED_{{__run_id}}_destination_ref_id");
        await loc.fill(resolvedValue, { timeout: 15000 });
      ...
      }
      {
        ...
        const resolvedValue = resolveTemplateString(__ctx, "free_travel");
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/vacation_offer/{{state_action_record_id_activate}}");
      ...
      await expect(page.locator(`#vacation_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#vacation_offer_action_activate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/vacation_offer/{{state_action_record_id_deactivate}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#vacation_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#vacation_offer_action_deactivate`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const targetValue = resolveTemplateString(__ctx, "/pages/travel/vacation_offer/{{state_action_record_id_expire}}");
        const target = /^https?:\/\//.test(targetValue)
          ? targetValue
          : new URL(targetValue, "http://localhost:4100/").toString();
        await page.goto(target);
      ...
      await expect(page.locator(`#vacation_offer_detail`)).toBeVisible({ timeout: 15000 });
      {
        const loc = page.locator(`#vacation_offer_action_expire`).first();
        await loc.waitFor({ state: 'visible', timeout: 15000 });
        const clickedId = await loc.getAttribute('phx-value-id') || await loc.getAttribute('data-id');
        const confirmText = await loc.getAttribute('data-confirm');
        await loc.scrollIntoViewIfNeeded();
      ...
      {
        const expectedUrl = resolveTemplateString(__ctx, "/pages/travel/vacation_offer");
      try {
