defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "approve" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.approve"},
    "complete" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.complete"},
    "complete_direct" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.complete_direct"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.get"},
    "reject" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.reject"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelChangeOrder.update"}
  }
