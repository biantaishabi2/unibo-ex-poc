defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "approve" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.approve"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.create"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.get"},
    "refund" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.refund"},
    "refund_direct" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.refund_direct"},
    "reject" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.reject"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelRefundOrder.update"}
  }
  ...
  @impl true
  def handle_event("action_approve", params, socket) do
    # UI action event name: action_approve
    socket = dispatch_backend("action_approve", params, socket)
    {:noreply, socket}
  end
  ...
  @impl true
  def handle_event("action_reject", params, socket) do
    # UI action event name: action_reject
    socket = dispatch_backend("action_reject", params, socket)
    {:noreply, socket}
  end
