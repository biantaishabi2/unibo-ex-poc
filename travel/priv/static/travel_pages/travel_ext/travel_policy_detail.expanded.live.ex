defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @backend_api_map %{
    "activate" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelPolicy.activate"},
    "create" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelPolicy.create"},
    "deactivate" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelPolicy.deactivate"},
    "get" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelPolicy.get"},
    "update" => %{module: __MODULE__.Backend, fun: :handle_event, api: "TravelExt.TravelPolicy.update"}
  }
