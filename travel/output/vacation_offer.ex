...
#   destroy --> [*]
# ```
defmodule Travel.Travel.VacationOffer do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :departure_city_ref, Travel.Ecommerce.TravelCity do
      public? true
    end
    belongs_to :destination_ref, Travel.Ecommerce.TravelCity do
      public? true
    end
