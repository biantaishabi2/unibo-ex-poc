...
#   destroy --> [*]
# ```
defmodule Travel.Travel.HotelOffer do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :city_ref, Travel.Ecommerce.TravelCity do
      public? true
    end
    belongs_to :hotel_ref, Travel.Travel.TravelHotel do
      public? true
    end
    belongs_to :room_type_ref, Travel.Travel.TravelRoomType do
      public? true
    end
