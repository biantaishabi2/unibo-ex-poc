...
#   destroy --> [*]
# ```
defmodule Travel.Travel.TravelOrder do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :hotel_offer, Travel.Travel.HotelOffer do
      public? true
    end
    belongs_to :flight_offer, Travel.Travel.FlightOffer do
      public? true
    end
    belongs_to :vacation_offer, Travel.Travel.VacationOffer do
      public? true
    end
    belongs_to :train_offer, Travel.Travel.TrainOffer do
      public? true
    end
    has_many :fulfillments, Travel.Travel.TravelFulfillment do
      public? true
      destination_attribute :travel_order_id
    end
    belongs_to :customer, Travel.Sales.Customer do
      public? true
    end
    belongs_to :payment, Travel.Payment.Payment do
      public? true
    end
  end
...
创建订单（别名 create_order）. Conditional requirements: product_type=hotel -> hotel_offer_id required; product_type=flight -> flight_offer_id required; product_type=vacation -> vacation_offer_id required; product_type=train -> train_offer_id required. Headers: x-tenant-id. doc_url: graphql://contract/travel/create_travel_travel_order"
      ...
      change Travel.Travel.Integrations.TravelOrder.CreateShopCallerContextResolveBridge
    end
    update :update do
    ...
    update :confirm_quote do
      ...
      change Travel.Travel.Integrations.TravelOrder.ConfirmQuoteShopEligibilityQuoteBridge
    ...
    update :submit_order do
      ...
      change Travel.Travel.Integrations.TravelOrder.SubmitOrderPaymentCaptureBridge
    ...
    update :submit_waitlist do
      ...
      change Travel.Travel.Integrations.TravelOrder.SubmitWaitlistPaymentCaptureBridge
      change AshStateMachine.BuiltinChanges.transition_state(:submitted)
      require_atomic? false
    end
    update :mark_payment_succeeded do
      ...
      change Travel.Travel.Integrations.TravelOrder.MarkPaymentSucceededSupplierBookingSubmitBridge
    ...
    update :request_cancel do
      ...
      change Travel.Travel.Integrations.TravelOrder.RequestCancelCreateApprovalInstanceBridge
