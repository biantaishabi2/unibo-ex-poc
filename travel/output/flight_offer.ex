...
#   destroy --> [*]
# ```
defmodule Travel.Travel.FlightOffer do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :departure_airport_ref, Travel.Ecommerce.TravelAirport do
      public? true
    end
    belongs_to :arrival_airport_ref, Travel.Ecommerce.TravelAirport do
      public? true
    end
    belongs_to :airline_ref, Travel.Travel.TravelAirline do
      public? true
    end
    belongs_to :cabin_class_ref, Travel.Travel.TravelCabinClass do
      public? true
    end
    has_many :orders, Travel.Travel.TravelOrder do
      public? true
