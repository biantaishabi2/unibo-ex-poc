defmodule Travel.Travel.Integrations.TravelChangeOrder.SubmitCreateApprovalInstanceBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_change_order.submit.create_approval_instance"
    payload =
      %{
