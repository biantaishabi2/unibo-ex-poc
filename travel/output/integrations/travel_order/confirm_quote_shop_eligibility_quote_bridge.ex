defmodule Travel.Travel.Integrations.TravelOrder.ConfirmQuoteShopEligibilityQuoteBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_order.confirm_quote.shop_eligibility_quote"
    payload =
      %{
        "entity" => "travel_order",
        "action" => "confirm_quote",
        "integration" => "shop_eligibility_quote",
