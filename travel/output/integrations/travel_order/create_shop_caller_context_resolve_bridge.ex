defmodule Travel.Travel.Integrations.TravelOrder.CreateShopCallerContextResolveBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_order.create.shop_caller_context_resolve"
    payload =
      %{
        "entity" => "travel_order",
        "action" => "create",
