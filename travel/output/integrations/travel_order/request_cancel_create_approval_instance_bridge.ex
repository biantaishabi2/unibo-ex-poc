defmodule Travel.Travel.Integrations.TravelOrder.RequestCancelCreateApprovalInstanceBridge do
  use Ash.Resource.Change

  @provider "create_approval_instance"
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_order.request_cancel.create_approval_instance"
    payload =
      %{
        "entity" => "travel_order",
        "action" => "request_cancel",
        "integration" => "create_approval_instance",
