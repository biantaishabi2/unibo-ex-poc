defmodule Travel.Travel.Integrations.TravelOrder.SubmitOrderPaymentCaptureBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_order.submit_order.payment_capture"
    payload =
      %{
        "entity" => "travel_order",
        "action" => "submit_order",
