defmodule Travel.Travel.Integrations.TravelFulfillment.ConfirmBookingSupplierConfirmBookingBridge do
  use Ash.Resource.Change

  @provider "supplier_confirm_booking"
  @action "confirm_booking"
  @declared_errors ["supplier_booking_rejected", "supplier_timeout"]
  @request_bindings []
  @response_bindings []

  @impl true
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "travel_fulfillment.confirm_booking.supplier_confirm_booking"
    payload =
      %{
        "entity" => "travel_fulfillment",
        "action" => "confirm_booking",
        "integration" => "supplier_confirm_booking",
