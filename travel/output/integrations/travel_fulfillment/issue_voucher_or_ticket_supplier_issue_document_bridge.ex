defmodule Travel.Travel.Integrations.TravelFulfillment.IssueVoucherOrTicketSupplierIssueDocumentBridge do
  use Ash.Resource.Change

  @provider "supplier_issue_document"
  @action "issue_voucher_or_ticket"
  @declared_errors ["issue_failed", "issue_timeout"]
  @request_bindings []
  @response_bindings []
