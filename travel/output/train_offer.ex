...
#   destroy --> [*]
# ```
defmodule Travel.Travel.TrainOffer do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :departure_station_ref, Travel.Ecommerce.TravelStation do
      public? true
    end
    belongs_to :arrival_station_ref, Travel.Ecommerce.TravelStation do
      public? true
    end
