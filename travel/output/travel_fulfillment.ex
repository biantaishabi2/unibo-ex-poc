...
#   destroy --> [*]
# ```
defmodule Travel.Travel.TravelFulfillment do
  use Ash.Resource,
    otp_app: :unibo_v4,
  ...
  relationships do
    belongs_to :order, Travel.Travel.TravelOrder do
      public? true
      allow_nil? false
      source_attribute :travel_order_id
    end
    belongs_to :shipment, Travel.Delivery.Shipment do
      public? true
    end
  end
  ...
  actions do
    ...
    update :confirm_booking do
      ...
      change Travel.Travel.Integrations.TravelFulfillment.ConfirmBookingSupplierConfirmBookingBridge
      require_atomic? false
    end
    update :issue_voucher_or_ticket do
      ...
      change Travel.Travel.Integrations.TravelFulfillment.IssueVoucherOrTicketSupplierIssueDocumentBridge
      require_atomic? false
    end
    ...
    update :cancel_fulfillment do
      ...
      change Travel.Travel.Integrations.TravelFulfillment.CancelFulfillmentSupplierCancelBookingBridge
      require_atomic? false
    end
