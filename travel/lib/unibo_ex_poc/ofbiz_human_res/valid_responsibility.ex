defmodule UniboExPoc.Ofbiz.HumanRes.ValidResponsibility do
  ...
  graphql do
    type :human_res_valid_responsibility

    queries do
      get :get_human_res_valid_responsibility, :read
      list :list_human_res_valid_responsibilitys, :read
    end

    mutations do
      create :create_human_res_valid_responsibility, :create
      update :update_human_res_valid_responsibility, :update
      destroy :delete_human_res_valid_responsibility, :destroy
    end
