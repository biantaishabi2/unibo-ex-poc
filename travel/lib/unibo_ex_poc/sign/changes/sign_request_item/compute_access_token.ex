defmodule UniboExPoc.Sign.Changes.SignRequestItem.ComputeAccessToken do
  @moduledoc """
  Change 模块: 计算 :access_token (entity: sign_request_item)
  原始 expr: op: func args: - generate_uuid
  """

  use Ash.Resource.Change
  @expr %{op: "func", args: ["generate_uuid"]}
  @field :access_token
