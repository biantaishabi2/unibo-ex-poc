...
{"steps":[{"idempotency_key":null,"next":["update","deactivate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["update","deactivate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"update"},{"idempotency_key":null,"next":["activate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"deactivate"},{"idempotency_key":null,"next":["update","deactivate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"activate"}],"workflow":"plan_lifecycle"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(SubscriptionPlan, :create, params), ash_opts)
      :update ->
