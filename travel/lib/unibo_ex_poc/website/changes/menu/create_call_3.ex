defmodule UniboExPoc.Website.Changes.Menu.CreateCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :reassign_parent, 2) do
      apply(module, :reassign_parent, [changeset, context])
    else
