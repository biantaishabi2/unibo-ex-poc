defmodule UniboExPoc.Website.Changes.WebPage.UnpublishCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :cow_branch, 2) do
      apply(module, :cow_branch, [changeset, context])
    else
