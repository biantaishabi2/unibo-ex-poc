defmodule UniboExPoc.Website.Changes.WebSite.UpdateCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :format_domain, 2) do
      apply(module, :format_domain, [changeset, context])
    else
