defmodule UniboExPoc.Ecommerce.Changes.ProductTemplate.DiscontinueCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :sanitize_html, 2) do
      apply(module, :sanitize_html, [changeset, context])
    else
