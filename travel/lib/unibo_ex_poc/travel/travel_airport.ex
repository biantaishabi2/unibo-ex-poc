defmodule UniboExPoc.Travel.TravelAirport do
  use Ash.Resource,
    otp_app: :travel,
  ...
  resource do
    description "机场主数据（Travel 层，来源 OFBiz Geo）"
  end
  ...
  graphql do
    type :travel_travel_airport

    queries do
      get :get_travel_travel_airport, :read
      list :list_travel_travel_airports, :read
    end

    mutations do
      create :create_travel_travel_airport, :create
      update :update_travel_travel_airport, :update
    end
  ...
  actions do
    ...
    create :create do
      primary? true
      accept [:airport_code, :airport_name, :city_code, :iata_code, :icao_code, :geo_id, :status]
    ...
    update :update do
      primary? true
      accept [:airport_name, :city_code, :iata_code, :icao_code, :geo_id, :status]
      change fn changeset, _context ->
        id = Ash.Changeset.get_attribute(changeset, :id)
