defmodule UniboExPoc.Ofbiz.Product.InventoryItemLabelType do
  use Ash.Resource,
    otp_app: :travel,
  ...
  relationships do
    belongs_to :parent_inventory_item_label_type, UniboExPoc.Ofbiz.Product.InventoryItemLabelType do
      public? true
