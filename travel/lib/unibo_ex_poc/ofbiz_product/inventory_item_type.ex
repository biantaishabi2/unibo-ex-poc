defmodule UniboExPoc.Ofbiz.Product.InventoryItemType do
  use Ash.Resource,
  ...
  attributes do
    uuid_primary_key :id
    attribute :inventory_item_type_id, :string, public?: true
  ...
  relationships do
    belongs_to :parent_inventory_item_type, UniboExPoc.Ofbiz.Product.InventoryItemType do
      public? true
