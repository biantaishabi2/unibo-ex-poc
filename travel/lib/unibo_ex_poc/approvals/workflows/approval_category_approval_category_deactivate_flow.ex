defmodule UniboExPoc.Approvals.Workflows.ApprovalCategory.ApprovalCategoryDeactivateFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
