defmodule UniboExPoc.Marketing.Workflows.EventTicket.EventTicketMaintainFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  支持分支路由、失败回退、重试与幂等扩展钩子。
  """

  alias UniboExPoc.Marketing.EventTicket
