defmodule UniboExPoc.Marketing.Workflows.Event.EventLifecycleWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  支持分支路由、失败回退、重试与幂等扩展钩子。
  """

  alias UniboExPoc.Marketing.Event
...
"""
  ...
  defp next_candidates(step) do
    case step do
      ...
      :update -> [:publish]
      :publish -> [:complete, :cancel, :set_done]
      :complete -> [:cancel]
      :cancel -> [:set_done]
      :set_done -> []
      _ -> []
