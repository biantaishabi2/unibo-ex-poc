defmodule UniboExPoc.Ofbiz.Order.OrderShipment do
  use Ash.Resource,
  ...
  graphql do
    type :order_order_shipment

    queries do
      get :get_order_order_shipment, :read
      list :list_order_order_shipments, :read
    end

    mutations do
      create :create_order_order_shipment, :create
      update :update_order_order_shipment, :update
      destroy :delete_order_order_shipment, :destroy
    end
