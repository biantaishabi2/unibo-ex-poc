defmodule UniboExPoc.Ofbiz.Order do
  ...
  resources do
    ...
    resource UniboExPoc.Ofbiz.Order.OrderAdjustmentBilling.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderContactMech.Version
    resource UniboExPoc.Ofbiz.Order.OrderContent
    resource UniboExPoc.Ofbiz.Order.OrderContent.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemAssoc.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemAttribute.Version
    resource UniboExPoc.Ofbiz.Order.OrderItemBilling
    resource UniboExPoc.Ofbiz.Order.OrderItemBilling.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemContactMech.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemGroupOrder.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemRole.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderItemShipGroupAssoc.Version
    resource UniboExPoc.Ofbiz.Order.OrderItemShipGrpInvRes
    resource UniboExPoc.Ofbiz.Order.OrderItemShipGrpInvRes.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderRole.Version
    resource UniboExPoc.Ofbiz.Order.OrderShipment
    resource UniboExPoc.Ofbiz.Order.OrderShipment.Version
    ...
    resource UniboExPoc.Ofbiz.Order.OrderSummaryEntry.Version
    resource UniboExPoc.Ofbiz.Order.OrderTerm
    resource UniboExPoc.Ofbiz.Order.OrderTerm.Version
    resource UniboExPoc.Ofbiz.Order.OrderTermAttribute
    resource UniboExPoc.Ofbiz.Order.OrderTermAttribute.Version
    ...
    resource UniboExPoc.Ofbiz.Order.ProductOrderItem.Version
    resource UniboExPoc.Ofbiz.Order.WorkOrderItemFulfillment
    resource UniboExPoc.Ofbiz.Order.WorkOrderItemFulfillment.Version
    ...
    resource UniboExPoc.Ofbiz.Order.QuoteRole.Version
    resource UniboExPoc.Ofbiz.Order.QuoteTerm
    resource UniboExPoc.Ofbiz.Order.QuoteTerm.Version
    resource UniboExPoc.Ofbiz.Order.QuoteTermAttribute
    resource UniboExPoc.Ofbiz.Order.QuoteTermAttribute.Version
    ...
    resource UniboExPoc.Ofbiz.Order.CustRequestContent.Version
    ...
    resource UniboExPoc.Ofbiz.Order.CustRequestItemNote.Version
    resource UniboExPoc.Ofbiz.Order.CustRequestItemWorkEffort
    resource UniboExPoc.Ofbiz.Order.CustRequestItemWorkEffort.Version
    ...
    resource UniboExPoc.Ofbiz.Order.CustRequestParty.Version
    ...
    resource UniboExPoc.Ofbiz.Order.RespondingParty.Version
    ...
    resource UniboExPoc.Ofbiz.Order.RequirementBudgetAllocation.Version
    ...
    resource UniboExPoc.Ofbiz.Order.RequirementRole.Version
    ...
    resource UniboExPoc.Ofbiz.Order.ReturnItemBilling.Version
    resource UniboExPoc.Ofbiz.Order.ReturnItemShipment
    resource UniboExPoc.Ofbiz.Order.ReturnItemShipment.Version
    resource UniboExPoc.Ofbiz.Order.ReturnContactMech
    resource UniboExPoc.Ofbiz.Order.ReturnContactMech.Version
    ...
    resource UniboExPoc.Ofbiz.Order.CartAbandonedLine.Version
    ...
    resource UniboExPoc.Ofbiz.Order.ShoppingListItemAttribute.Version
    resource UniboExPoc.Ofbiz.Order.ShoppingListItemSurvey
    resource UniboExPoc.Ofbiz.Order.ShoppingListItemSurvey.Version
    ...
    resource UniboExPoc.Ofbiz.Order.AllocationPlanHeader.Version
    resource UniboExPoc.Ofbiz.Order.AllocationPlanItem
    resource UniboExPoc.Ofbiz.Order.AllocationPlanItem.Version
  end
end
