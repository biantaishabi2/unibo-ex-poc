defmodule UniboExPoc.Sales.Changes.SalesOrderItem.ComputePriceSubtotal do
  ...
  @expr %{op: "func", name: "tax_compute", args: %{qty: %{op: "ref", args: ["quantity"]}, price: %{op: "ref", args: ["unit_price"]}, discount: %{op: "ref", args: ["discount_rate"]}, taxes: %{op: "ref", args: ["tax_ids"]}}, extract: "amount_untaxed"}
