defmodule UniboExPoc.Project.Workflows.Task.TaskLifecycleFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
...
{"steps":[{"idempotency_key":null,"next":["assign"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["start"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"assign"},{"idempotency_key":null,"next":["complete"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"start"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"complete"}],"workflow":"task_lifecycle_flow"}
"""
