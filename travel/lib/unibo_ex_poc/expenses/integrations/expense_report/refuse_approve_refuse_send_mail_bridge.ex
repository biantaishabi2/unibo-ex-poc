defmodule UniboExPoc.Expenses.Integrations.ExpenseReport.RefuseApproveRefuseSendMailBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "expense_report.refuse.approve_refuse_send_mail"
    payload =
      %{
