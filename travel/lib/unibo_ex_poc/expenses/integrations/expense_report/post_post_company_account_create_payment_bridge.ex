defmodule UniboExPoc.Expenses.Integrations.ExpenseReport.PostPostCompanyAccountCreatePaymentBridge do
  use Ash.Resource.Change

  @provider "post_company_account_create_payment"
  @action "post"
  @declared_errors []
  @request_bindings []
  @response_bindings []
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "expense_report.post.post_company_account_create_payment"
    payload =
      %{
        "entity" => "expense_report",
        "action" => "post",
        "integration" => "post_company_account_create_payment",
