defmodule UniboExPoc.HR.Workflows.Employee.EmployeeWriteFlowWorkflow do
  ...
  def steps do
    [:create, :update, :terminate, :suspend, :reactivate]
  end

  @workflow_semantics_json ~S"""
{"steps":[{"idempotency_key":null,"next":["update"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["terminate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"update"},{"idempotency_key":null,"next":["suspend"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"terminate"},{"idempotency_key":null,"next":["reactivate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"suspend"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"reactivate"}],"workflow":"employee_write_flow"}
"""
  ...
  defp retry_policy(step) do
    case step do
      ...
      :terminate -> %{max_attempts: 1, backoff_ms: 0}
      :suspend -> %{max_attempts: 1, backoff_ms: 0}
