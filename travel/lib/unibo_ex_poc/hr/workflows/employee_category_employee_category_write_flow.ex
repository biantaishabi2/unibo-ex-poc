defmodule UniboExPoc.HR.Workflows.EmployeeCategory.EmployeeCategoryWriteFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  支持分支路由、失败回退、重试与幂等扩展钩子。
  """

  alias UniboExPoc.HR.EmployeeCategory
...
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :s1_create ->
        Ash.create(Ash.Changeset.for_create(EmployeeCategory, :create, params), ash_opts)
      :s2_update ->
