...
{"steps":[{"idempotency_key":null,"next":["action_validate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_validate"}],"workflow":"work_entry_validation_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(WorkEntry, :create, params), ash_opts)
      :action_validate ->
