...
{"steps":[{"idempotency_key":null,"next":["open"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["close"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"open"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"close"}],"workflow":"requisition_filled_flow"}
"""
