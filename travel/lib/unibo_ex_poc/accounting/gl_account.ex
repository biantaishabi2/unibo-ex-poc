...
defmodule UniboExPoc.Accounting.GlAccount do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Gl Account via Create. doc_url: graphql://contract/accounting/create_accounting_gl_account"
      primary? true
    ...
    update :update do
      description "Update Gl Account via Update. doc_url: graphql://contract/accounting/update_accounting_gl_account"
      primary? true
...
停用科目 [R-GL-002]. doc_url: graphql://contract/accounting/deactivate_accounting_gl_account"
      accept []
