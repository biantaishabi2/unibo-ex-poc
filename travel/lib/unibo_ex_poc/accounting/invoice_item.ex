...
defmodule UniboExPoc.Accounting.InvoiceItem do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Invoice Item via Create. doc_url: graphql://contract/accounting/create_accounting_invoice_item"
      primary? true
    ...
    update :update do
      description "Update Invoice Item via Update. doc_url: graphql://contract/accounting/update_accounting_invoice_item"
      primary? true
