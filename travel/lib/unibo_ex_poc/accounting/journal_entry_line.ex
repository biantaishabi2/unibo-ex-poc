...
defmodule UniboExPoc.Accounting.JournalEntryLine do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Journal Entry Line via Create. doc_url: graphql://contract/accounting/create_accounting_journal_entry_line"
      primary? true
    ...
    update :update do
      description "Update Journal Entry Line via Update. doc_url: graphql://contract/accounting/update_accounting_journal_entry_line"
      primary? true
