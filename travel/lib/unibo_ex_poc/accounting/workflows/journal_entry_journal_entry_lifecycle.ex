...
{"steps":[{"idempotency_key":null,"next":["post"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["cancel","reset_to_draft"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"post"},{"idempotency_key":null,"next":["reset_to_draft"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"cancel"},{"idempotency_key":null,"next":["post"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"reset_to_draft"}],"workflow":"journal_entry_lifecycle"}
"""
