...
defmodule UniboExPoc.Accounting.BillingAccount do
  ...
  postgres do
    ...
    identity_index_names unique_account_number: "idx_accounting_billing_accounts_unique_account_number"
  end
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Billing Account via Create. doc_url: graphql://contract/accounting/create_accounting_billing_account"
      primary? true
    ...
    update :update do
      description "Update Billing Account via Update. doc_url: graphql://contract/accounting/update_accounting_billing_account"
      primary? true
