defmodule UniboExPoc.Accounting.Changes.JournalEntry.ComputeTotalDebit do
  @moduledoc """
  Change 模块: 计算 :total_debit (entity: journal_entry)
  原始 expr: op: func args: - sum - op: ref   args:   - lines   - debit_amount
  """

  use Ash.Resource.Change
  @expr %{op: "func", args: ["sum", %{op: "ref", args: ["lines", "debit_amount"]}]}
  @field :total_debit
