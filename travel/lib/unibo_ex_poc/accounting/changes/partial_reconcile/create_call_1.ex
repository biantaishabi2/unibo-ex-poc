defmodule UniboExPoc.Accounting.Changes.PartialReconcile.CreateCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :reduce_residual, 2) do
      apply(module, :reduce_residual, [changeset, context])
    else
      Ash.Changeset.add_error(changeset, "call 目标不存在: #UniboExPoc.Accounting.reduce_residual/2")
    end
  end
