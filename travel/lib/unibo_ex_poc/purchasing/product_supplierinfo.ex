...
defmodule UniboExPoc.Purchasing.ProductSupplierinfo do
  ...
  postgres do
    ...
    identity_index_names unique_supplier_product: "idx_purchasing_product_supplierinfos_unique_supplier_product"
  end
  ...
  actions do
    ...
    create :create do
      description "Create Product Supplierinfo via Create. doc_url: graphql://contract/purchasing/create_purchasing_product_supplierinfo"
      primary? true
    ...
    update :update do
      description "Update Product Supplierinfo via Update. doc_url: graphql://contract/purchasing/update_purchasing_product_supplierinfo"
      primary? true
