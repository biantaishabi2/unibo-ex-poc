...
defmodule UniboExPoc.Purchasing.PurchaseRequisitionType do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Purchase Requisition Type via Create. doc_url: graphql://contract/purchasing/create_purchasing_purchase_requisition_type"
      primary? true
    ...
    update :update do
      description "Update Purchase Requisition Type via Update. doc_url: graphql://contract/purchasing/update_purchasing_purchase_requisition_type"
      primary? true
      accept [:name, :description, :sequence, :exclusive, :quantity_copy, :line_copy, :active, :parent_type_id, :has_table]
