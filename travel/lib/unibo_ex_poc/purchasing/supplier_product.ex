...
defmodule UniboExPoc.Purchasing.SupplierProduct do
  ...
  actions do
    ...
    create :create do
      description "Create Supplier Product via Create. doc_url: graphql://contract/purchasing/create_purchasing_supplier_product"
      primary? true
    ...
    update :update do
      description "Update Supplier Product via Update. doc_url: graphql://contract/purchasing/update_purchasing_supplier_product"
      primary? true
