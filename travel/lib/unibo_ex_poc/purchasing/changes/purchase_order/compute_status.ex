defmodule UniboExPoc.Purchasing.Changes.PurchaseOrder.ComputeStatus do
  ...
  @expr %{op: "if", args: [%{op: "call", module: "approval", method: "approval_allowed", args: [%{op: "ref", args: ["company_party_id"]}, %{op: "ref", args: ["amount_total"]}, %{op: "ref", args: ["actor"]}]}, "purchase", "to_approve"]}
  @field :status
