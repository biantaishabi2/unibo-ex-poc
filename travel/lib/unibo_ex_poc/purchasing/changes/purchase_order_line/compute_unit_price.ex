defmodule UniboExPoc.Purchasing.Changes.PurchaseOrderLine.ComputeUnitPrice do
  ...
  @expr %{op: "call", module: "product", method: "compute_price_unit", args: %{partner_id: %{op: "ref", args: ["order", "supplier", "id"]}, product_id: %{op: "ref", args: ["product_id"]}, quantity: %{op: "ref", args: ["quantity"]}, date_order: %{op: "ref", args: ["order", "date_order"]}, currency_id: %{op: "ref", args: ["order", "currency_id"]}}}
  @field :unit_price
