...
defmodule UniboExPoc.Purchasing.PurchaseRequisitionItem do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Purchase Requisition Item via Create. doc_url: graphql://contract/purchasing/create_purchasing_purchase_requisition_item"
      primary? true
    ...
    update :update do
      description "Update Purchase Requisition Item via Update. doc_url: graphql://contract/purchasing/update_purchasing_purchase_requisition_item"
      primary? true
