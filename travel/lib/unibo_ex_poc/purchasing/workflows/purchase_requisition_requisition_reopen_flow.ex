defmodule UniboExPoc.Purchasing.Workflows.PurchaseRequisition.RequisitionReopenFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
...
"""
  ...
  defp next_candidates(step) do
    case step do
      ...
      :s2_action_draft -> [:s3_action_in_progress]
      :s3_action_in_progress -> []
      _ -> []
    end
  end
  ...
  defp retry_policy(step) do
    case step do
      ...
      :s3_action_in_progress -> %{max_attempts: 1, backoff_ms: 0}
