...
{"steps":[{"idempotency_key":null,"next":["action_draft"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_cancel"},{"idempotency_key":null,"next":["action_in_progress"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_draft"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_in_progress"}],"workflow":"requisition_reopen_flow"}
"""
  ...
  defp next_candidates(step) do
    case step do
      ...
      :action_draft -> [:action_in_progress]
      :action_in_progress -> []
      _ -> []
    end
  end
