...
{"steps":[{"idempotency_key":null,"next":["action_in_progress"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["action_open"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_in_progress"},{"idempotency_key":null,"next":["action_done"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_open"},{"idempotency_key":null,"next":["action_cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_done"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_cancel"}],"workflow":"requisition_lifecycle_flow"}
"""
  ...
  defp next_candidates(step) do
    case step do
      :create -> [:action_in_progress]
      :action_in_progress -> [:action_open]
      :action_open -> [:action_done]
  ...
  defp retry_policy(step) do
    case step do
      ...
      :action_in_progress -> %{max_attempts: 1, backoff_ms: 0}
