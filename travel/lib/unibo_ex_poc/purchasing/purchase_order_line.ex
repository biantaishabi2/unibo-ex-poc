...
defmodule UniboExPoc.Purchasing.PurchaseOrderLine do
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Purchase Order Line via Create. doc_url: graphql://contract/purchasing/create_purchasing_purchase_order_line"
      primary? true
    ...
    update :update do
      description "Update Purchase Order Line via Update. doc_url: graphql://contract/purchasing/update_purchasing_purchase_order_line"
      primary? true
