defmodule UniboExPoc.Ofbiz.Accounting.FixedAssetType do
  use Ash.Resource,
    otp_app: :travel,
  ...
  postgres do
    table "accounting_fixed_asset_types"
  ...
  attributes do
    uuid_primary_key :id
    attribute :fixed_asset_type_id, :string, public?: true
  ...
  relationships do
    belongs_to :parent_fixed_asset_type, UniboExPoc.Ofbiz.Accounting.FixedAssetType do
      public? true
