defmodule UniboExPoc.Ofbiz.Accounting.InvoiceItemAssocType do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_invoice_item_assoc_type, UniboExPoc.Ofbiz.Accounting.InvoiceItemAssocType do
      public? true
