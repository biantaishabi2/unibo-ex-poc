defmodule UniboExPoc.TravelExt.TravelPolicyCheck do
  use Ash.Resource,
    otp_app: :travel,
  ...
  postgres do
    table "travel_ext_travel_policy_checks"
    repo UniboExPoc.Repo
    identity_index_names unique_order: "idx_travel_ext_travel_policy_checks_unique_order"
  end

  graphql do
    type :travel_ext_travel_policy_check

    queries do
      get :get_travel_ext_travel_policy_check, :read
      list :list_travel_ext_travel_policy_checks, :read
    end

    mutations do
      create :create_travel_ext_travel_policy_check, :create
    end
  ...
  relationships do
    ...
    belongs_to :policy, UniboExPoc.TravelExt.TravelPolicy do
      public? true
      allow_nil? false
    end
  end
  ...
  actions do
    ...
    create :create do
      description "Create Travel Policy Check via Create. doc_url: graphql://contract/travel_ext/create_travel_ext_travel_policy_check"
      primary? true
