...
#   activate --> deactivate
# ```
defmodule UniboExPoc.TravelExt.TravelPolicy do
  use Ash.Resource,
    otp_app: :travel,
  ...
  postgres do
    table "travel_ext_travel_policies"
    repo UniboExPoc.Repo
    identity_index_names unique_policy_scope: "idx_travel_ext_travel_policies_unique_policy_scope"
  end

  graphql do
    type :travel_ext_travel_policy

    queries do
      get :get_travel_ext_travel_policy, :read
      list :list_travel_ext_travel_policys, :read
      get :get_match_policy_travel_ext_travel_policy, :match_policy
      list :list_match_policy_travel_ext_travel_policys, :match_policy
    end

    mutations do
      create :create_travel_ext_travel_policy, :create
      update :update_travel_ext_travel_policy, :update
      update :activate_travel_ext_travel_policy, :activate
      update :deactivate_travel_ext_travel_policy, :deactivate
    end
  ...
  actions do
    defaults [:read]
    create :create do
      description "Create Travel Policy via Create. doc_url: graphql://contract/travel_ext/create_travel_ext_travel_policy"
      primary? true
    ...
    update :update do
      description "Update Travel Policy via Update. doc_url: graphql://contract/travel_ext/update_travel_ext_travel_policy"
      primary? true
    ...
    update :activate do
      description "Update Travel Policy via Activate. doc_url: graphql://contract/travel_ext/activate_travel_ext_travel_policy"
      accept []
    ...
    update :deactivate do
      description "Update Travel Policy via Deactivate. doc_url: graphql://contract/travel_ext/deactivate_travel_ext_travel_policy"
      accept []
      change fn changeset, _ctx ->
        current = Ash.Changeset.get_attribute(changeset, :is_active)
        if current == true do
