defmodule UniboExPoc.Ofbiz.WorkEffort.WorkEffortBilling do
  ...
  graphql do
    type :work_effort_work_effort_billing

    queries do
      get :get_work_effort_work_effort_billing, :read
      list :list_work_effort_work_effort_billings, :read
    end

    mutations do
      create :create_work_effort_work_effort_billing, :create
      update :update_work_effort_work_effort_billing, :update
      destroy :delete_work_effort_work_effort_billing, :destroy
    end
