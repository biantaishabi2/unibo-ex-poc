defmodule UniboExPoc.Calendar.WorkScheduleTranslation do
  use Ash.Resource,
    otp_app: :travel,
  ...
  postgres do
    table "calendar_work_schedule_translations"
  ...
  identities do
    identity :unique_translation, [:work_schedule_id, :locale, :field_name]
  end
