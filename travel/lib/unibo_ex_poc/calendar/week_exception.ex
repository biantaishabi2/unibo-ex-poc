...
#   remove --> [*]
# ```
defmodule UniboExPoc.Calendar.WeekException do
  use Ash.Resource,
    otp_app: :travel,
  ...
  relationships do
    ...
    belongs_to :override_week_template, UniboExPoc.Calendar.WeekTemplate do
      public? true
    end
    has_many :translations, UniboExPoc.Calendar.WeekExceptionTranslation, public?: true
  end
