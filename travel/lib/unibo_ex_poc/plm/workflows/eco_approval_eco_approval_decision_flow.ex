defmodule UniboExPoc.PLM.Workflows.EcoApproval.EcoApprovalDecisionFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  支持分支路由、失败回退、重试与幂等扩展钩子。
  """

  alias UniboExPoc.PLM.EcoApproval
...
{"steps":[{"idempotency_key":null,"next":["approve","reject"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["reject"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"approve"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"reject"}],"workflow":"eco_approval_decision_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(EcoApproval, :create, params), ash_opts)
      :approve ->
