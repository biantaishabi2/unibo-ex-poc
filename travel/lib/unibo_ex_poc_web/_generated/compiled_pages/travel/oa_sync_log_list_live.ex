defmodule UniboExPocWeb.Pages.Travel.OaSyncLogListLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="oa_sync_log_list">
