defmodule UniboExPocWeb.Pages.Travel.ChangeConfirmLive do
  @moduledoc """
  ...
  @backend_embedded_page %{page_id: "change_confirm", page_kind: "detail", api_map: %{create: "Travel.TravelChangeOrder.create", list: "Travel.TravelChangeOrder.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/change_confirm", query: "", kind: "detail"}, state_schema: %{defaults: %{step_1_label: "基本信息", step_2_label: "详细配置", step_3_label: "确认提交"}}, status_keys: []}
  ...
  def render(assigns) do
    ~H"""
    <.page title="表单" id="change_confirm">
        ...
        <.card variant="default" id="wz_step_1_card">
          ...
          <.card_content id="wz_step_1_content">
            <.stack direction="column" id="wz_step_1_grid">
              <.input size="md" name="travel_change_order[change_reason]" id="form_change_reason" />
              <.input size="md" name="travel_change_order[price_difference]" id="form_price_difference" />
              <.input size="md" name="travel_change_order[change_fee]" id="form_change_fee" />
              <.input size="md" name="travel_change_order[new_offer_id]" id="form_new_offer_id" />
              <.select size="md" name="travel_change_order[approval_mode]" id="form_approval_mode" :let={builder}>
