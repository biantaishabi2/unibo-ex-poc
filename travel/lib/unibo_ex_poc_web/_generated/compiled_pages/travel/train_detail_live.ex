defmodule UniboExPocWeb.Pages.Travel.TrainDetailLive do
  ...
  @graphql_field_map %{"get" => "get_travel_train_offer", "list" => "list_travel_train_offers"}
  @input_allowlist %{}
  @input_type_name_map %{}
    ...
    case normalized do
      "form_submit" ->
        record_id = get_in(socket.assigns, [:record, :id]) || get_in(socket.assigns, [:record, "id"]) ||
          get_in(socket.assigns, [:train_offer, :id]) || get_in(socket.assigns, [:train_offer, "id"])
  ...
  defp __resolve_compiled_id(params, socket) do
    Map.get(params, "id") ||
      ...
      (socket.assigns[:train_offer] && socket.assigns[:train_offer]["id"]) || ""
  end
