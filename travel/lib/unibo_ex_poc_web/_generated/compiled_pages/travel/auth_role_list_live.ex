defmodule UniboExPocWeb.Pages.Travel.AuthRoleListLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="auth_role_list">
