defmodule UniboExPocWeb.Pages.Travel.TravelerManagementLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="traveler_management">
