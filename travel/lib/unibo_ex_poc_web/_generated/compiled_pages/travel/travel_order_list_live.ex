defmodule UniboExPocWeb.Pages.Travel.TravelOrderListLive do
  @moduledoc """
  ...
  @backend_params_accept ["product_type", "booking_mode", "status", "change_status", "waitlist_status"]
  @backend_info_reload_messages []
  @backend_api_map %{
    "list" => %{module: UniboExPocWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelOrder.list"}
  }
  @backend_embedded_page %{page_id: "travel_order_list", page_kind: "list", api_map: %{list: "Travel.TravelOrder.list"}, backend: %{load: %{selection: "booking_mode: bookingMode change_status: changeStatus contact_name: contactName contact_phone: contactPhone currency host_enterprise_id: hostEnterpriseId host_member_id: hostMemberId host_shop_id: hostShopId id order_no: orderNo original_order_ref: originalOrderRef payment_external_ref: paymentExternalRef points_deduction_amount: pointsDeductionAmount points_to_use: pointsToUse product_type: productType recommended_payment_method: recommendedPaymentMethod seat_selection_snapshot: seatSelectionSnapshot status supplier_order_ref: supplierOrderRef tenant_id: tenantId ticket_passenger_infos: ticketPassengerInfos total_amount: totalAmount traveler_count: travelerCount waitlist_status: waitlistStatus"}}, route: %{path: "/pages/travel/travel_order", query: "", kind: "list"}, state_schema: %{defaults: %{travel_order: %{page: "", total_pages: ""}, rows_empty: true, rows: [%{id: "row_01", order_no: "", product_type: "", booking_mode: "", contact_name: "", contact_phone: "", traveler_count: "", total_amount: "", points_to_use: "", points_deduction_amount: "", recommended_payment_method: "", currency: "", status: "", change_status: "", waitlist_status: "", original_order_ref: "", ticket_passenger_infos: "", seat_selection_snapshot: "", supplier_order_ref: "", payment_external_ref: ""}, %{id: "row_02", order_no: "", product_type: "", booking_mode: "", contact_name: "", contact_phone: "", traveler_count: "", total_amount: "", points_to_use: "", points_deduction_amount: "", recommended_payment_method: "", currency: "", status: "", change_status: "", waitlist_status: "", original_order_ref: "", ticket_passenger_infos: "", seat_selection_snapshot: "", supplier_order_ref: "", payment_external_ref: ""}, %{id: "row_03", order_no: "", product_type: "", booking_mode: "", contact_name: "", contact_phone: "", traveler_count: "", total_amount: "", points_to_use: "", points_deduction_amount: "", recommended_payment_method: "", currency: "", status: "", change_status: "", waitlist_status: "", original_order_ref: "", ticket_passenger_infos: "", seat_selection_snapshot: "", supplier_order_ref: "", payment_external_ref: ""}]}}, status_keys: ["rows", "rows_empty", "filter", "loading"]}
  ...
  assigns = assigns
  effects = []
  effects = [%{to: "/pages/travel/travel_order/new", type: "navigate"} | effects]
  effects = __interpolate_effects(effects, params)
  %{assigns: assigns, effects: Enum.reverse(effects)}
end
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="travel_order_list">
