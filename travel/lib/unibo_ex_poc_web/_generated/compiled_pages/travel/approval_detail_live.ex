defmodule UniboExPocWeb.Pages.Travel.ApprovalDetailLive do
  ...
  @backend_embedded_page %{page_id: "approval_detail", page_kind: "detail", api_map: %{get: "Travel.TravelPolicyCheck.get", list: "Travel.TravelPolicyCheck.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/approval_detail", query: "", kind: "detail"}, state_schema: %{defaults: %{travel_policy_check: %{check_result: "", policy_amount: "", actual_amount: "", exceed_amount: "", exceed_ratio: "", exceed_strategy: "", exceed_reason: "", personal_pay_amount: "", approval_mode: ""}, editing: false}}, status_keys: []}
