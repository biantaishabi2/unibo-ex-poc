defmodule UniboExPocWeb.Pages.Travel.FlightOfferTreeLive do
  @moduledoc """
  ...
  @backend_embedded_page %{page_id: "flight_offer_tree", page_kind: "list", api_map: %{list: "Travel.FlightOffer.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/flight_offer_tree", query: "", kind: "list"}, state_schema: %{defaults: %{flight_offer: %{page: "", total_pages: ""}, rows_empty: true, rows: [%{id: "row_01", supplier_code: "", itinerary_code: "", flight_no: "", departure_airport_code: "", arrival_airport_code: "", departure_at: "", arrival_at: "", cabin_class: "", fare_family: "", listed_price: "", settlement_price: "", currency: "", seats_available: "", baggage_policy: "", refund_change_policy: "", sale_status: ""}, %{id: "row_02", supplier_code: "", itinerary_code: "", flight_no: "", departure_airport_code: "", arrival_airport_code: "", departure_at: "", arrival_at: "", cabin_class: "", fare_family: "", listed_price: "", settlement_price: "", currency: "", seats_available: "", baggage_policy: "", refund_change_policy: "", sale_status: ""}, %{id: "row_03", supplier_code: "", itinerary_code: "", flight_no: "", departure_airport_code: "", arrival_airport_code: "", departure_at: "", arrival_at: "", cabin_class: "", fare_family: "", listed_price: "", settlement_price: "", currency: "", seats_available: "", baggage_policy: "", refund_change_policy: "", sale_status: ""}]}}, status_keys: []}
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="flight_offer_tree">
        ...
        <.card variant="default" id="filter_card">
          <.card_content id="filter_content">
            <.flex gap={4} align="center" direction="row" id="filter_row">
              <.input name="departure_at_from" label="起飞时间 起" size="md" id="filter_departure_at" />
              <.select size="md" name="flight_offer[sale_status]" id="filter_sale_status" :let={builder}>
                ...
                <.select_content builder={builder}>
                  <.select_group>
                    ...
                    <.select_item builder={builder} value="" label="expired">expired</.select_item>
                  </.select_group>
                </.select_content>
              </.select>
      ...
      <.section layout="grid" columns={2} id="table_section">
        <.split ratio="1:3" id="main_split">
          <.stack direction="column" id="left_panel">
            <.tree content="按航空公司分组" id="airline_tree" />
          </.stack>
          <.stack direction="column" id="right_panel" />
        </.split>
        <.table id="data_table">
