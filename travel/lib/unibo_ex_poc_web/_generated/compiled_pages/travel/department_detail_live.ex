defmodule UniboExPocWeb.Pages.Travel.DepartmentDetailLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="department_detail">
