defmodule UniboExPocWeb.Pages.Travel.JobPositionListLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="列表" id="job_position_list">
