defmodule UniboExPocWeb.Pages.Travel.EmployeeDetailLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="employee_detail">
