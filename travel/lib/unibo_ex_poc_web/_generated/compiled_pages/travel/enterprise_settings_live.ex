defmodule UniboExPocWeb.Pages.Travel.EnterpriseSettingsLive do
  ...
  # status.keys preview (first ~40): record, record.is_active, record.logo, record.notify_frequency, record.notify_method, record.password_policy, record.session_timeout, record.site_description, record.site_name
  ...
  @backend_embedded_page %{page_id: "enterprise_settings", page_kind: "detail", api_map: %{get: "Travel.TravelPolicy.get", list: "Travel.TravelPolicy.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/enterprise_settings", query: "", kind: "detail"}, state_schema: %{defaults: %{record: %{is_active: true, site_name: "", logo: "", site_description: "", notify_method: "", notify_frequency: "", session_timeout: "", password_policy: ""}}}, status_keys: []}
