defmodule UniboExPocWeb.Pages.Travel.PersonalCenterLive do
  ...
  @backend_embedded_page %{page_id: "personal_center", page_kind: "detail", api_map: %{get: "Travel.TravelOrder.get", list: "Travel.TravelOrder.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/personal_center", query: "", kind: "detail"}, state_schema: %{defaults: %{page_title: "个人中心", profile_description: ""}}, status_keys: []}
