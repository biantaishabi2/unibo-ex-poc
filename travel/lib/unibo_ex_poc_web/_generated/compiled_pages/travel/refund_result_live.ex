defmodule UniboExPocWeb.Pages.Travel.RefundResultLive do
  @moduledoc """
  ...
  @backend_api_map %{
    ...
    "list" => %{module: UniboExPocWeb.Graphql.StitchBackend, fun: :dispatch, api: "Travel.TravelRefundOrder.list"}
  }
  @backend_embedded_page %{page_id: "refund_result", page_kind: "detail", api_map: %{get: "Travel.TravelRefundOrder.get", list: "Travel.TravelRefundOrder.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/refund_result", query: "", kind: "detail"}, state_schema: %{defaults: %{record: %{status: true}, travel_refund_order: %{refund_reason: "", refund_fee: "", refund_amount: "", status: "", approval_mode: ""}, editing: false}}, status_keys: []}
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="refund_result">
              ...
              <.form for={%{}} phx-submit="form_submit" phx-change="form_change" id="edit_form">
                <.grid columns={2} gap={4} id="form_grid">
                  <.stack direction="column" id="form_fields">
                    <.input size="md" name="travel_refund_order[refund_reason]" id="form_refund_reason" value={get_in(@travel_refund_order, [:refund_reason]) || ""} />
                    <.input size="md" name="travel_refund_order[refund_fee]" id="form_refund_fee" value={get_in(@travel_refund_order, [:refund_fee]) || ""} />
                    <.input size="md" name="travel_refund_order[refund_amount]" id="form_refund_amount" value={get_in(@travel_refund_order, [:refund_amount]) || ""} />
                    <.select size="md" name="travel_refund_order[approval_mode]" id="form_approval_mode" :let={builder} value={get_in(@travel_refund_order, [:approval_mode]) || ""}>
