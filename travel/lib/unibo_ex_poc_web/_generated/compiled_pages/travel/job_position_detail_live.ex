defmodule UniboExPocWeb.Pages.Travel.JobPositionDetailLive do
  @moduledoc """
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="job_position_detail">
