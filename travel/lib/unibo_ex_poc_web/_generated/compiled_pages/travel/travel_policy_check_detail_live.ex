defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "actual_amount", "personal_pay_amount", "policy_amount", "exceed_amount", "exceed_reason", "approval_request_id", "exceed_strategy", "approval_mode", "exceed_ratio", "check_result"]
