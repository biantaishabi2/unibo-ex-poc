defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "approval_request_id", "approval_mode", "exceed_amount", "personal_pay_amount", "exceed_reason", "exceed_ratio", "actual_amount", "policy_amount", "check_result", "exceed_strategy"]
