defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "policy_amount", "exceed_amount", "exceed_strategy", "check_result", "exceed_ratio", "approval_request_id", "actual_amount", "exceed_reason", "personal_pay_amount", "approval_mode"]
