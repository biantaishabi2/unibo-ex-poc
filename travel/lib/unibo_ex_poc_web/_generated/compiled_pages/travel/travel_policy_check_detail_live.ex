defmodule UniboExPocWeb.Pages.Travel.TravelPolicyCheckDetailLive do
  ...
  @backend_params_accept ["id", "order_id", "policy_id", "exceed_reason", "personal_pay_amount", "actual_amount", "approval_request_id", "approval_mode", "check_result", "policy_amount", "exceed_strategy", "exceed_amount", "exceed_ratio"]
