defmodule UniboExPocWeb.Pages.Travel.PolicyCheckDetailLive do
  @moduledoc """
  ...
  @backend_embedded_page %{page_id: "policy_check_detail", page_kind: "detail", api_map: %{get: "Travel.TravelPolicyCheck.get", list: "Travel.TravelPolicyCheck.list"}, backend: %{load: %{selection: "id"}}, route: %{path: "/pages/travel/policy_check_detail", query: "", kind: "detail"}, state_schema: %{defaults: %{travel_policy_check: %{check_result: "", policy_amount: "", actual_amount: "", exceed_amount: "", exceed_ratio: "", exceed_strategy: "", exceed_reason: "", personal_pay_amount: "", approval_mode: ""}, editing: false}}, status_keys: []}
  ...
  def render(assigns) do
    ~H"""
    <.page title="详情" id="policy_check_detail">
