defmodule UniboExPocWeb.Pages.Travel.TravelOrderDetailLive do
  ...
  @backend_params_accept ["id", "hotel_offer_id", "ticket_passenger_infos", "traveler_count", "total_amount", "seat_selection_snapshot", "customer_id", "points_deduction_amount", "currency", "contact_name", "points_to_use", "host_shop_id", "contact_phone", "product_type", "order_no"]
