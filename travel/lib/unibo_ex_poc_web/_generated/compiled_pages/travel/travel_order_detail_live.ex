defmodule UniboExPocWeb.Pages.Travel.TravelOrderDetailLive do
  ...
  @backend_params_accept ["id", "hotel_offer_id", "customer_id", "traveler_count", "points_to_use", "currency", "order_no", "product_type", "total_amount", "points_deduction_amount", "ticket_passenger_infos", "host_shop_id", "seat_selection_snapshot", "contact_phone", "contact_name"]
  ...
  assigns = assigns
  effects = []
  effects = [%{to: "/travel/travel_order", type: "navigate"} | effects]
  effects = __interpolate_effects(effects, params)
  %{assigns: assigns, effects: Enum.reverse(effects)}
end
