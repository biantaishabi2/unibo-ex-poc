defmodule UniboExPocWeb.Pages.Travel.TravelOrderDetailLive do
  ...
  @backend_params_accept ["id", "hotel_offer_id", "currency", "seat_selection_snapshot", "total_amount", "customer_id", "product_type", "order_no", "points_deduction_amount", "host_shop_id", "traveler_count", "contact_phone", "points_to_use", "contact_name", "ticket_passenger_infos"]
