defmodule UniboExPocWeb.Pages.Travel.TravelChangeOrderListLive do
  ...
  @backend_embedded_page %{page_id: "travel_change_order_list", page_kind: "list", api_map: %{list: "Travel.TravelChangeOrder.list"}, backend: %{load: %{selection: "approval_mode: approvalMode change_fee: changeFee change_reason: changeReason id new_offer_id: newOfferId price_difference: priceDifference status"}}, route: %{path: "/pages/travel/travel_change_order", query: "", kind: "list"}, state_schema: %{defaults: %{travel_change_order: %{page: "", total_pages: ""}, rows_empty: true, rows: [%{id: "row_01", change_reason: "", price_difference: "", change_fee: "", status: "", approval_mode: ""}, %{id: "row_02", change_reason: "", price_difference: "", change_fee: "", status: "", approval_mode: ""}, %{id: "row_03", change_reason: "", price_difference: "", change_fee: "", status: "", approval_mode: ""}]}}, status_keys: ["rows", "rows_empty", "filter", "loading"]}
