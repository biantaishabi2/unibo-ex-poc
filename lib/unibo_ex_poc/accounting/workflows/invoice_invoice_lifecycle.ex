...
{"steps":[{"idempotency_key":null,"next":["approve","void"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["send","void"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"approve"},{"idempotency_key":null,"next":["void"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"send"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"void"}],"workflow":"invoice_lifecycle"}
"""
  ...
  defp retry_policy(step) do
    case step do
      ...
      :void -> %{max_attempts: 1, backoff_ms: 0}
