defmodule UniboExPoc.Accounting.Changes.JournalEntry.ComputeAmountUntaxed do
  ...
  @expr %{op: "mul", args: [%{op: "func", args: ["direction_sign", %{op: "ref", args: ["move_type"]}]}, %{op: "func", args: ["sum", %{op: "filter", args: [%{op: "ref", args: ["lines", "balance"]}, %{op: "in", args: [%{op: "ref", args: ["lines", "display_type"]}, ["product", "rounding"]]}]}]}]}
