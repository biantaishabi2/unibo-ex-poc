defmodule UniboV4.Accounting.Changes.JournalEntry.ComputeAmountTax do
  ...
  @expr %{op: "mul", args: [%{op: "func", args: ["direction_sign", %{op: "ref", args: ["move_type"]}]}, %{op: "func", args: ["sum", %{op: "filter", args: [%{op: "ref", args: ["lines", "balance"]}, %{op: "eq", args: [%{op: "ref", args: ["lines", "display_type"]}, "tax"]}]}]}]}
  @field :amount_tax
