defmodule UniboExPoc.Accounting.Changes.Invoice.ComputeTotalAmount do
  @moduledoc """
  Change 模块: 计算 :total_amount (entity: invoice)
  原始 expr: op: func args: - sum - op: ref   args:   - items   - amount
  """

  use Ash.Resource.Change
  @expr %{op: "func", args: ["sum", %{op: "ref", args: ["items", "amount"]}]}
  @field :total_amount
