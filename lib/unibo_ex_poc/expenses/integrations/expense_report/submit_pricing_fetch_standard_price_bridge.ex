defmodule UniboExPoc.Expenses.Integrations.ExpenseReport.SubmitPricingFetchStandardPriceBridge do
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "expense_report.submit.pricing_fetch_standard_price"
    payload =
      %{
        "entity" => "expense_report",
        "action" => "submit",
        "integration" => "pricing_fetch_standard_price",
