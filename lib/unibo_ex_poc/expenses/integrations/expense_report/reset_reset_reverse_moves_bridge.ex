defmodule UniboExPoc.Expenses.Integrations.ExpenseReport.ResetResetReverseMovesBridge do
  use Ash.Resource.Change

  @provider "reset_reverse_moves"
  @action "reset"
  @declared_errors []
  @request_bindings []
  @response_bindings []
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "expense_report.reset.reset_reverse_moves"
    payload =
      %{
        "entity" => "expense_report",
        "action" => "reset",
        "integration" => "reset_reverse_moves",
