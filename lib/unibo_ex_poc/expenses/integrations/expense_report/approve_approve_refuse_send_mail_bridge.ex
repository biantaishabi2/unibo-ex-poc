defmodule UniboExPoc.Expenses.Integrations.ExpenseReport.ApproveApproveRefuseSendMailBridge do
  use Ash.Resource.Change

  @provider "approve_refuse_send_mail"
  @action "approve"
  @declared_errors []
  @request_bindings []
  @response_bindings []
  ...
  def change(changeset, _opts, context) do
    request_id = resolve_context_path(context, "correlation.request_id") || Map.get(context, :request_id) || "expense_report.approve.approve_refuse_send_mail"
    payload =
      %{
        "entity" => "expense_report",
        "action" => "approve",
        "integration" => "approve_refuse_send_mail",
