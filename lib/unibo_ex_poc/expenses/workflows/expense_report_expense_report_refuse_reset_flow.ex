...
{"steps":[{"idempotency_key":null,"next":["submit"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["refuse"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"submit"},{"idempotency_key":null,"next":["reset"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"refuse"},{"idempotency_key":null,"next":["submit"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"reset"},{"idempotency_key":null,"next":["approve"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"submit"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"approve"}],"workflow":"expense_report_refuse_reset_flow"}
"""
