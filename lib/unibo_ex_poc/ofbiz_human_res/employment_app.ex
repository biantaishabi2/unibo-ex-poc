defmodule UniboV4.Ofbiz.HumanRes.EmploymentApp do
  use Ash.Resource,
  ...
  relationships do
    ...
    belongs_to :employment_app_source_type, UniboV4.Ofbiz.HumanRes.EmploymentAppSourceType do
      public? true
      attribute_type :string
    end
    belongs_to :applying_party, UniboV4.Ofbiz.HumanRes.Party do
      public? true
      attribute_type :string
    end
    belongs_to :referred_by_party, UniboV4.Ofbiz.HumanRes.Party do
      public? true
      attribute_type :string
    end
