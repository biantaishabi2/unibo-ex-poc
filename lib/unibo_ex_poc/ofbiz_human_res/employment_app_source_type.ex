defmodule UniboExPoc.Ofbiz.HumanRes.EmploymentAppSourceType do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_employment_app_source_type, UniboExPoc.Ofbiz.HumanRes.EmploymentAppSourceType do
      public? true
