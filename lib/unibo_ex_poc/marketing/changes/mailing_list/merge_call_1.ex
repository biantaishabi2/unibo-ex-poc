defmodule UniboExPoc.Marketing.Changes.MailingList.MergeCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :deduplicate_by_email, 2) do
      apply(module, :deduplicate_by_email, [changeset, context])
    else
