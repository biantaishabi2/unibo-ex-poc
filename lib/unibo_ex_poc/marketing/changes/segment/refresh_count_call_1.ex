defmodule UniboExPoc.Marketing.Changes.Segment.RefreshCountCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :recompute_member_count, 2) do
      apply(module, :recompute_member_count, [changeset, context])
    else
