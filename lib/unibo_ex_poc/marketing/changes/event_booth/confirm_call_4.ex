defmodule UniboExPoc.Marketing.Changes.EventBooth.ConfirmCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :post_confirmation_message, 2) do
      apply(module, :post_confirmation_message, [changeset, context])
    else
