defmodule UniboExPoc.Marketing.Changes.AutomationTrace.ExecuteCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_yes_branch_traces, 2) do
      apply(module, :create_yes_branch_traces, [changeset, context])
    else
