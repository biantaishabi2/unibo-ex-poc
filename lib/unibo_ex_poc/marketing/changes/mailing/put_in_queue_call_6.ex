defmodule UniboExPoc.Marketing.Changes.Mailing.PutInQueueCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :generate_unsubscribe_token, 2) do
      apply(module, :generate_unsubscribe_token, [changeset, context])
    else
