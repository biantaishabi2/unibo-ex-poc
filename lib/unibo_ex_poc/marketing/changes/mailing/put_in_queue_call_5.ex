defmodule UniboExPoc.Marketing.Changes.Mailing.PutInQueueCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :exclude_opted_out_and_blacklisted, 2) do
      apply(module, :exclude_opted_out_and_blacklisted, [changeset, context])
    else
