defmodule UniboExPoc.Marketing.Changes.Mailing.CancelCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :clear_schedule_date, 2) do
      apply(module, :clear_schedule_date, [changeset, context])
    else
