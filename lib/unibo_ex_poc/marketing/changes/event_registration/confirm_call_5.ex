defmodule UniboExPoc.Marketing.Changes.EventRegistration.ConfirmCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :trigger_after_sub_mails, 2) do
      apply(module, :trigger_after_sub_mails, [changeset, context])
    else
