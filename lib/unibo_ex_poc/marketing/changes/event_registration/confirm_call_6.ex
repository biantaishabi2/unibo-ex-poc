defmodule UniboExPoc.Marketing.Changes.EventRegistration.ConfirmCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :auto_create_partner, 2) do
      apply(module, :auto_create_partner, [changeset, context])
    else
