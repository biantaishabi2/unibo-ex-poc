defmodule UniboExPoc.Quality.Changes.QualityCheck.DoFailCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :block_ref_document, 2) do
      apply(module, :block_ref_document, [changeset, context])
    else
