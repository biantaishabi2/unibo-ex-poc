defmodule UniboV4.Ofbiz.Product.ProductCategoryContentType do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_product_category_content_type, UniboV4.Ofbiz.Product.ProductCategoryContentType do
      public? true
