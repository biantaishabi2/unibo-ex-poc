defmodule UniboV4.Ofbiz.Product.Facility do
  use Ash.Resource,
  ...
  graphql do
    type :product_facility

    queries do
      get :get_product_facility, :read
      list :list_product_facilitys, :read
    end

    mutations do
      create :create_product_facility, :create
      update :update_product_facility, :update
      destroy :delete_product_facility, :destroy
    end
  ...
  relationships do
    belongs_to :facility_type, UniboV4.Ofbiz.Product.FacilityType do
      public? true
    end
    belongs_to :parent_facility, UniboV4.Ofbiz.Product.Facility do
      public? true
    end
    ...
    belongs_to :default_inventory_item_type, UniboV4.Ofbiz.Product.InventoryItemType do
      public? true
    end
