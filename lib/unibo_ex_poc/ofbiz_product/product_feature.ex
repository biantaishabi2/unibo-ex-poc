defmodule UniboV4.Ofbiz.Product.ProductFeature do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :product_feature_category, UniboV4.Ofbiz.Product.ProductFeatureCategory do
      public? true
    end
    belongs_to :product_feature_type, UniboV4.Ofbiz.Product.ProductFeatureType do
      public? true
    end
  end
