defmodule UniboExPoc.Rental.Changes.RentalOrder.ActionConfirmCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_stock_pickings, 2) do
      apply(module, :create_stock_pickings, [changeset, context])
    else
