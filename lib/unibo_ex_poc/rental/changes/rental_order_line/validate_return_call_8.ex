defmodule UniboExPoc.Rental.Changes.RentalOrderLine.ValidateReturnCall8 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :recompute_rental_price, 2) do
      apply(module, :recompute_rental_price, [changeset, context])
    else
