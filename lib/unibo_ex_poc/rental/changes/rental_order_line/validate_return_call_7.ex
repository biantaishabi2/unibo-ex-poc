defmodule UniboExPoc.Rental.Changes.RentalOrderLine.ValidateReturnCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :compute_penalty, 2) do
      apply(module, :compute_penalty, [changeset, context])
    else
