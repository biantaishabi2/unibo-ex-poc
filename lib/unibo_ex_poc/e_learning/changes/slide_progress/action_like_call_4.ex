defmodule UniboExPoc.ELearning.Changes.SlideProgress.ActionLikeCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :toggle_vote, 2) do
      apply(module, :toggle_vote, [changeset, context])
    else
