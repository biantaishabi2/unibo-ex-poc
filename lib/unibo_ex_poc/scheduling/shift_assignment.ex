defmodule UniboExPoc.Scheduling.ShiftAssignment do
  use Ash.Resource,
  ...
  relationships do
    ...
    belongs_to :requirement, UniboExPoc.Scheduling.CoverageRequirement do
      public? true
      allow_nil? false
    end
    belongs_to :version, UniboExPoc.Scheduling.ScheduleVersion do
      public? true
      allow_nil? false
    end
    belongs_to :employee, UniboExPoc.Scheduling.Employee do
      public? true
      allow_nil? false
    end
    belongs_to :baseline_run, UniboExPoc.Scheduling.SolverRun do
      public? true
    end
