defmodule UniboExPoc.Knowledge.Changes.Article.ActionPublishCall20 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_version_snapshot, 2) do
      apply(module, :create_version_snapshot, [changeset, context])
    else
