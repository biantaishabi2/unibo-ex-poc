defmodule UniboExPoc.Knowledge.Changes.Article.ActionRestoreTrashCall19 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :restore_trash_reparent, 2) do
      apply(module, :restore_trash_reparent, [changeset, context])
    else
