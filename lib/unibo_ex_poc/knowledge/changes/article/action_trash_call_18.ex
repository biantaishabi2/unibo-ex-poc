defmodule UniboExPoc.Knowledge.Changes.Article.ActionTrashCall18 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :recursive_trash_descendants, 2) do
      apply(module, :recursive_trash_descendants, [changeset, context])
    else
