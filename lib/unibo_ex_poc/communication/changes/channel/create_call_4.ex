defmodule UniboExPoc.Communication.Changes.Channel.CreateCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :generate, 2) do
      apply(module, :generate, [changeset, context])
    else
