defmodule UniboExPoc.Communication.Changes.ChannelMember.DestroyCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :broadcast_event, 2) do
      apply(module, :broadcast_event, [changeset, context])
    else
