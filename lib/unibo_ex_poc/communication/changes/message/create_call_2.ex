defmodule UniboExPoc.Communication.Changes.Message.CreateCall2 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :extract_inline_images, 2) do
      apply(module, :extract_inline_images, [changeset, context])
    else
      Ash.Changeset.add_error(changeset, "call 目标不存在: #Communication.extract_inline_images/2")
    end
  end
