defmodule UniboExPoc.Communication.Changes.Message.CreateCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :update_all_channel_members, 2) do
      apply(module, :update_all_channel_members, [changeset, context])
    else
