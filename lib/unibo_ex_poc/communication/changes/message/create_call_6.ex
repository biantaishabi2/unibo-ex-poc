defmodule UniboExPoc.Communication.Changes.Message.CreateCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :extract_voice_metadata, 2) do
      apply(module, :extract_voice_metadata, [changeset, context])
    else
