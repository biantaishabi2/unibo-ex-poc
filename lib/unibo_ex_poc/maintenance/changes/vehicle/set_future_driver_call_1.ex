defmodule UniboExPoc.Maintenance.Changes.Vehicle.SetFutureDriverCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :compute_model_fields, 2) do
      apply(module, :compute_model_fields, [changeset, context])
    else
