defmodule UniboExPoc.Maintenance.Changes.Vehicle.ChangeDriverCall2 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_assignment_log, 2) do
      apply(module, :create_assignment_log, [changeset, context])
    else
