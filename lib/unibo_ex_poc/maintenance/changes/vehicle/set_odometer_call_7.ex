defmodule UniboExPoc.Maintenance.Changes.Vehicle.SetOdometerCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :append_odometer, 2) do
      apply(module, :append_odometer, [changeset, context])
    else
