defmodule UniboExPoc.Maintenance.Changes.Contract.ActionExpireCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :auto_state_transition, 2) do
      apply(module, :auto_state_transition, [changeset, context])
    else
