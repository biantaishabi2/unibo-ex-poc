defmodule UniboExPoc.Maintenance.Changes.Contract.ActionExpireCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :reschedule_renewal_activity, 2) do
      apply(module, :reschedule_renewal_activity, [changeset, context])
    else
