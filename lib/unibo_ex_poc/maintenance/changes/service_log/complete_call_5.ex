defmodule UniboExPoc.Maintenance.Changes.ServiceLog.CompleteCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :compute_purchaser, 2) do
      apply(module, :compute_purchaser, [changeset, context])
    else
