defmodule UniboExPoc.Maintenance.Changes.RepairOrder.CompleteRepairCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :action_done_stock, 2) do
      apply(module, :action_done_stock, [changeset, context])
    else
