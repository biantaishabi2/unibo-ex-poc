defmodule UniboExPoc.Maintenance.Changes.RepairOrder.CompleteRepairCall15 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :warranty_pricing, 2) do
      apply(module, :warranty_pricing, [changeset, context])
    else
