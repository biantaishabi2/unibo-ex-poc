defmodule UniboExPoc.Maintenance.Changes.RepairOrder.CancelCall9 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :cancel_all_stock_moves, 2) do
      apply(module, :cancel_all_stock_moves, [changeset, context])
    else
