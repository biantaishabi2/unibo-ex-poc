defmodule UniboExPoc.Maintenance.Changes.RepairOrder.CompleteRepairCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_product_move, 2) do
      apply(module, :create_product_move, [changeset, context])
    else
