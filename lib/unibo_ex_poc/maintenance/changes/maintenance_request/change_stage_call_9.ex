defmodule UniboExPoc.Maintenance.Changes.MaintenanceRequest.ChangeStageCall9 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :manage_activity, 2) do
      apply(module, :manage_activity, [changeset, context])
    else
