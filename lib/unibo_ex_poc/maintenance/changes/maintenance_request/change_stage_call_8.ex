defmodule UniboExPoc.Maintenance.Changes.MaintenanceRequest.ChangeStageCall8 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :clone_preventive, 2) do
      apply(module, :clone_preventive, [changeset, context])
    else
