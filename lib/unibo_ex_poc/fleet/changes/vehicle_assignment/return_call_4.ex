defmodule UniboExPoc.Fleet.Changes.VehicleAssignment.ReturnCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :set_related, 2) do
      apply(module, :set_related, [changeset, context])
    else
