...
{"steps":[{"idempotency_key":null,"next":["return","transfer"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"assign"},{"idempotency_key":null,"next":["transfer"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"return"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"transfer"}],"workflow":"vehicle_assignment_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :assign ->
        Ash.create(Ash.Changeset.for_create(VehicleAssignment, :assign, params), ash_opts)
      :return ->
        Ash.update(Ash.Changeset.for_update(record, :return, params), ash_opts)
      :transfer ->
