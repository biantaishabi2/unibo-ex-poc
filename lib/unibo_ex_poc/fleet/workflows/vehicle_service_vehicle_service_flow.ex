defmodule UniboExPoc.Fleet.Workflows.VehicleService.VehicleServiceFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  支持分支路由、失败回退、重试与幂等扩展钩子。
  """

  alias UniboExPoc.Fleet.VehicleService
...
{"steps":[{"idempotency_key":null,"next":["start","complete","cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"schedule"},{"idempotency_key":null,"next":["complete"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"start"},{"idempotency_key":null,"next":["cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"complete"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"cancel"}],"workflow":"vehicle_service_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :schedule ->
        Ash.create(Ash.Changeset.for_create(VehicleService, :schedule, params), ash_opts)
      :start ->
