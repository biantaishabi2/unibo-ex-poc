defmodule UniboExPoc.CRM.Workflows.Lead.LeadStageProgressionWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
...
{"steps":[{"idempotency_key":null,"next":["update","win","lose"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"update"}],"workflow":"lead_stage_progression"}
"""
