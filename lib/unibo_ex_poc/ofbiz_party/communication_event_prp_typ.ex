defmodule UniboExPoc.Ofbiz.Party.CommunicationEventPrpTyp do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_communication_event_prp_typ, UniboExPoc.Ofbiz.Party.CommunicationEventPrpTyp do
      public? true
