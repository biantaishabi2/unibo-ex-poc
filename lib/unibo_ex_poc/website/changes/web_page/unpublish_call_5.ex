defmodule UniboExPoc.Website.Changes.WebPage.UnpublishCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :sync_menu_url, 2) do
      apply(module, :sync_menu_url, [changeset, context])
    else
