defmodule UniboExPoc.Website.Changes.WebPage.UnpublishCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :slugify_url, 2) do
      apply(module, :slugify_url, [changeset, context])
    else
