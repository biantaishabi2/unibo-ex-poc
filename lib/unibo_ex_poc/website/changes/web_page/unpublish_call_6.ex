defmodule UniboExPoc.Website.Changes.WebPage.UnpublishCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :sync_homepage, 2) do
      apply(module, :sync_homepage, [changeset, context])
    else
