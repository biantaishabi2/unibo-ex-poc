defmodule UniboExPoc.Website.Changes.WebPage.UnpublishCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_redirect, 2) do
      apply(module, :create_redirect, [changeset, context])
    else
