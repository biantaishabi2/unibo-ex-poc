defmodule UniboExPoc.Website.Changes.WebSite.UpdateCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :scale_favicon, 2) do
      apply(module, :scale_favicon, [changeset, context])
    else
