defmodule UniboExPoc.Website.Changes.WebSite.CreateCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :auto_create_homepage, 2) do
      apply(module, :auto_create_homepage, [changeset, context])
    else
