defmodule UniboExPoc.Manufacturing.Changes.ManufacturingOrder.MarkDoneCall14 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :prepare_finished_extra_vals, 2) do
      apply(module, :prepare_finished_extra_vals, [changeset, context])
    else
