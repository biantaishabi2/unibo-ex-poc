defmodule UniboExPoc.Manufacturing.Changes.ManufacturingOrder.ConfirmCall7 do
  use Ash.Resource.Change

  @impl true
  def change(changeset, _opts, context) do
    module_ref = "stock.move"
    module = resolve_call_module(module_ref)
    if is_atom(module) and function_exported?(module, :adjust_procure_method, 2) do
      apply(module, :adjust_procure_method, [changeset, context])
    else
