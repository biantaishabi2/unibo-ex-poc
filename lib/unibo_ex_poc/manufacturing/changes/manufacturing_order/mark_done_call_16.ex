defmodule UniboExPoc.Manufacturing.Changes.ManufacturingOrder.MarkDoneCall16 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :cross_module_call, 2) do
      apply(module, :cross_module_call, [changeset, context])
    else
      Ash.Changeset.add_error(changeset, "call 目标不存在: #Manufacturing.cross_module_call/2")
    end
  end
