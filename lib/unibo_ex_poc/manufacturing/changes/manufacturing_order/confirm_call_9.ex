defmodule UniboExPoc.Manufacturing.Changes.ManufacturingOrder.ConfirmCall9 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :trigger_scheduler, 2) do
      apply(module, :trigger_scheduler, [changeset, context])
    else
