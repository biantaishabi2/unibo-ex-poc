defmodule UniboExPoc.Manufacturing.Changes.ManufacturingOrder.ConfirmCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :inherit_attribute, 2) do
      apply(module, :inherit_attribute, [changeset, context])
    else
