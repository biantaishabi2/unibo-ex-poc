...
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(BarcodeNomenclature, :create, params), ash_opts)
      :update ->
  ...
  defp next_candidates(step) do
    case step do
      ...
      :deactivate -> [:update, :activate, :destroy]
      :destroy -> []
      _ -> []
    end
  end
