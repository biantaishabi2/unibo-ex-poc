defmodule UniboExPoc.Helpdesk.Changes.HelpdeskTicket.ChangeStageCall11 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :update_sla_deadline, 2) do
      apply(module, :update_sla_deadline, [changeset, context])
    else
