defmodule UniboExPoc.Helpdesk.Changes.FieldServiceOrder.MarkDoneCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :trigger_inventory_deduction, 2) do
      apply(module, :trigger_inventory_deduction, [changeset, context])
    else
