defmodule UniboExPoc.Helpdesk.Changes.FieldServiceOrder.StopTimerCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_timesheet_entry, 2) do
      apply(module, :create_timesheet_entry, [changeset, context])
    else
