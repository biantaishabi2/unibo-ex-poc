defmodule UniboV4.Ofbiz.Order.Quote do
  use Ash.Resource,
  ...
  graphql do
    ...
    queries do
      get :get_order_quote, :read
      list :list_order_quotes, :read
    end

    mutations do
      create :create_order_quote, :create
      update :update_order_quote, :update
      destroy :delete_order_quote, :destroy
    end
  ...
  relationships do
    belongs_to :quote_type, UniboV4.Ofbiz.Order.QuoteType do
      public? true
      attribute_type :string
    end
    has_many :quote_note_view, UniboV4.Ofbiz.Order.QuoteNote do
      public? true
    end
  end
