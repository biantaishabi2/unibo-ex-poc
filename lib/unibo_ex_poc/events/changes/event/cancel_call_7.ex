defmodule UniboExPoc.Events.Changes.Event.CancelCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :notify_registrants, 2) do
      apply(module, :notify_registrants, [changeset, context])
    else
