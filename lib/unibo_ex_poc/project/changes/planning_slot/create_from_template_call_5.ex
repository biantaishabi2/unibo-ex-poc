defmodule UniboExPoc.Project.Changes.PlanningSlot.CreateFromTemplateCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :copy_from_template, 2) do
      apply(module, :copy_from_template, [changeset, context])
    else
