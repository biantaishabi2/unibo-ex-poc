defmodule UniboExPoc.Project.Changes.PlanningSlot.UpdateCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :send_notification, 2) do
      apply(module, :send_notification, [changeset, context])
    else
