defmodule UniboExPoc.Project.Changes.PlanningSlot.CreateCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :generate_recurrence, 2) do
      apply(module, :generate_recurrence, [changeset, context])
    else
