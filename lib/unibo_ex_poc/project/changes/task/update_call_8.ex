defmodule UniboExPoc.Project.Changes.Task.UpdateCall8 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :send_rating_request, 2) do
      apply(module, :send_rating_request, [changeset, context])
    else
