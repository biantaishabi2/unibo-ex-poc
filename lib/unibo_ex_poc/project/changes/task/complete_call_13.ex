defmodule UniboExPoc.Project.Changes.Task.CompleteCall13 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :parse_display_name, 2) do
      apply(module, :parse_display_name, [changeset, context])
    else
