defmodule UniboExPoc.Project.Changes.Task.CompleteCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_next_recurrence, 2) do
      apply(module, :create_next_recurrence, [changeset, context])
    else
