defmodule UniboExPoc.Project.Changes.Project.UnarchiveCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :unsubscribe_portal_users, 2) do
      apply(module, :unsubscribe_portal_users, [changeset, context])
    else
