defmodule UniboExPoc.Project.Changes.Project.CreateCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :auto_assign, 2) do
      apply(module, :auto_assign, [changeset, context])
    else
