defmodule UniboExPoc.Project.Changes.Project.UnarchiveCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :sync_stage_to_company, 2) do
      apply(module, :sync_stage_to_company, [changeset, context])
    else
