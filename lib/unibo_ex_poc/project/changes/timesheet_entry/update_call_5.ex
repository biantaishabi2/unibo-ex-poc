defmodule UniboExPoc.Project.Changes.TimesheetEntry.UpdateCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :compute_encoding_uom, 2) do
      apply(module, :compute_encoding_uom, [changeset, context])
    else
