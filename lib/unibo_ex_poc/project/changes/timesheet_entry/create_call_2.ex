defmodule UniboExPoc.Project.Changes.TimesheetEntry.CreateCall2 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :auto_resolve, 2) do
      apply(module, :auto_resolve, [changeset, context])
    else
