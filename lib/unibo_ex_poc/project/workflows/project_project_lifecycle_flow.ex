defmodule UniboExPoc.Project.Workflows.Project.ProjectLifecycleFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  ...
  def steps do
    [:create, :update, :start, :complete]
  end

  @workflow_semantics_json ~S"""
{"steps":[{"idempotency_key":null,"next":["update"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["start"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"update"},{"idempotency_key":null,"next":["complete"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"start"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"complete"}],"workflow":"project_lifecycle_flow"}
"""
