defmodule UniboExPoc.LiveChat.Changes.LiveChatChannel.CreateCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :add_relation, 2) do
      apply(module, :add_relation, [changeset, context])
    else
