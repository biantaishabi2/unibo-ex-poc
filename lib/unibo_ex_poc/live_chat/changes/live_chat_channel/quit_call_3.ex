defmodule UniboExPoc.LiveChat.Changes.LiveChatChannel.QuitCall3 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :remove_relation, 2) do
      apply(module, :remove_relation, [changeset, context])
    else
