...
{"steps":[{"idempotency_key":null,"next":["submit"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["refuse"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"submit"},{"idempotency_key":null,"next":["draft"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"refuse"},{"idempotency_key":null,"next":["submit"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"draft"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"submit"}],"workflow":"approval_request_refuse_resubmit_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(ApprovalRequest, :create, params), ash_opts)
      :submit ->
