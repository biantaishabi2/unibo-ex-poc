defmodule UniboExPoc.Approvals.Workflows.Approver.ApproverApproveFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
...
{"steps":[{"idempotency_key":null,"next":["approve"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"approve"}],"workflow":"approver_approve_flow"}
"""
