defmodule UniboExPoc.Approvals.Workflows.ApprovalRequest.ApprovalRequestApproveFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
