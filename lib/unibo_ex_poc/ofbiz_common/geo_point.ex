defmodule UniboV4.Ofbiz.Common.GeoPoint do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :data_source, UniboV4.Ofbiz.Common.DataSource do
      public? true
    end
    belongs_to :geo_point_type_enumeration, UniboV4.Ofbiz.Common.Enumeration do
      public? true
      source_attribute :geo_point_type_enum_id
    end
    belongs_to :elevation_uom, UniboV4.Ofbiz.Common.Uom do
      public? true
    end
  end
