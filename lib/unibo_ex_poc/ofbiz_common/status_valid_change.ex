defmodule UniboV4.Ofbiz.Common.StatusValidChange do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :main_status_item, UniboV4.Ofbiz.Common.StatusItem do
      public? true
      source_attribute :status_id
    end
    belongs_to :to_status_item, UniboV4.Ofbiz.Common.StatusItem do
      public? true
