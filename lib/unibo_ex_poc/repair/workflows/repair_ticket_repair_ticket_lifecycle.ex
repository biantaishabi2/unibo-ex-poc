...
{"steps":[{"idempotency_key":null,"next":["update","confirm","cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["start_repair","cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"confirm"},{"idempotency_key":null,"next":["complete_repair"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"start_repair"},{"idempotency_key":null,"next":["deliver"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"complete_repair"},{"idempotency_key":null,"next":["cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"deliver"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"cancel"}],"workflow":"repair_ticket_lifecycle"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(RepairTicket, :create, params), ash_opts)
      :confirm ->
