...
#   update --> [*]
# ```
defmodule UniboExPoc.PLM.EcoStage do
  use Ash.Resource,
  ...
  relationships do
    many_to_many :type_ids, UniboExPoc.PLM.EcoType do
      public? true
      through UniboExPoc.PLM.EcoTypeStageLink
    end
    has_many :approval_template_ids, UniboExPoc.PLM.EcoStageApprovalTemplate do
      public? true
