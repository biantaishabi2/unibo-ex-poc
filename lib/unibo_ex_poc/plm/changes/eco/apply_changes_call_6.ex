defmodule UniboExPoc.PLM.Changes.Eco.ApplyChangesCall6 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :update_draft_manufacturing_orders, 2) do
      apply(module, :update_draft_manufacturing_orders, [changeset, context])
    else
