defmodule UniboExPoc.PLM.Changes.Eco.AdvanceStageCall4 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_approvals_from_template, 2) do
      apply(module, :create_approvals_from_template, [changeset, context])
    else
