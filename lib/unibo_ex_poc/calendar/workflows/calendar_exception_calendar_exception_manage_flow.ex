...
{"steps":[{"idempotency_key":null,"next":["remove"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"add"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"remove"}],"workflow":"calendar_exception_manage_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :add ->
        Ash.create(Ash.Changeset.for_create(CalendarException, :add, params), ash_opts)
      :remove ->
