...
{"steps":[{"idempotency_key":null,"next":["action_open"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["action_close"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_open"},{"idempotency_key":null,"next":["action_draft"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_close"},{"idempotency_key":null,"next":["action_open"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_draft"}],"workflow":"survey_lifecycle"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(Survey, :create, params), ash_opts)
      :action_open ->
