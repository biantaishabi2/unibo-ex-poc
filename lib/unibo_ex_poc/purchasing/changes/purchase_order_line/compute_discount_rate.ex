defmodule UniboV4.Purchasing.Changes.PurchaseOrderLine.ComputeDiscountRate do
  ...
  @expr %{op: "call", module: "product", method: "get_seller_discount", args: %{partner_id: %{op: "ref", args: ["order", "supplier", "id"]}, product_id: %{op: "ref", args: ["product_id"]}, quantity: %{op: "ref", args: ["quantity"]}}}
  @field :discount_rate
