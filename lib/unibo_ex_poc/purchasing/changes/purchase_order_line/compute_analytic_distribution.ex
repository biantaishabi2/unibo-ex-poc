defmodule UniboExPoc.Purchasing.Changes.PurchaseOrderLine.ComputeAnalyticDistribution do
  ...
  @expr %{op: "call", module: "account", method: "get_analytic_distribution", args: %{product_id: %{op: "ref", args: ["product_id"]}, partner_id: %{op: "ref", args: ["order", "supplier", "id"]}, company_id: %{op: "ref", args: ["order", "company_id"]}}}
