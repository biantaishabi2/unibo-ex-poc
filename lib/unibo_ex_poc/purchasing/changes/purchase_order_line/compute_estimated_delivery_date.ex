defmodule UniboV4.Purchasing.Changes.PurchaseOrderLine.ComputeEstimatedDeliveryDate do
  ...
  @expr %{op: "add", args: [%{op: "ref", args: ["order", "date_order"]}, %{op: "call", module: "product", method: "get_seller_delay", args: %{partner_id: %{op: "ref", args: ["order", "supplier", "id"]}, product_id: %{op: "ref", args: ["product_id"]}}}]}
