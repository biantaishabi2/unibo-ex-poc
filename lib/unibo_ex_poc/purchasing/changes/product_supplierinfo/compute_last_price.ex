defmodule UniboV4.Purchasing.Changes.ProductSupplierinfo.ComputeLastPrice do
  ...
  @expr %{op: "call", module: "currency", method: "convert", args: %{amount: %{op: "ref", args: ["source_price"]}, from_currency: %{op: "ref", args: ["order_currency_id"]}, to_currency: %{op: "ref", args: ["currency_uom_id"]}}}
  @field :last_price
