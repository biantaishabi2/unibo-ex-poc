...
{"steps":[{"idempotency_key":null,"next":["action_cancel"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"action_cancel"}],"workflow":"work_entry_cancel_flow"}
"""
