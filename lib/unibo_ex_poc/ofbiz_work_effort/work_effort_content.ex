defmodule UniboExPoc.Ofbiz.WorkEffort.WorkEffortContent do
  ...
  graphql do
    type :work_effort_work_effort_content

    queries do
      get :get_work_effort_work_effort_content, :read
      list :list_work_effort_work_effort_contents, :read
    end

    mutations do
      create :create_work_effort_work_effort_content, :create
      update :update_work_effort_work_effort_content, :update
      destroy :delete_work_effort_work_effort_content, :destroy
    end
