defmodule UniboExPoc.POS.Changes.PosPayment.CreateCall1 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :route_accounting, 2) do
      apply(module, :route_accounting, [changeset, context])
    else
