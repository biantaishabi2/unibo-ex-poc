defmodule UniboExPoc.POS.Changes.PosSession.CloseCall8 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_account_payments, 2) do
      apply(module, :create_account_payments, [changeset, context])
    else
