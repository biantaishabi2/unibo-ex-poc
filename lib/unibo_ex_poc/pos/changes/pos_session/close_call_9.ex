defmodule UniboExPoc.POS.Changes.PosSession.CloseCall9 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_bank_statement_lines, 2) do
      apply(module, :create_bank_statement_lines, [changeset, context])
    else
