defmodule UniboExPoc.POS.Changes.PosSession.CloseCall12 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :create_profit_loss_statement_line, 2) do
      apply(module, :create_profit_loss_statement_line, [changeset, context])
    else
