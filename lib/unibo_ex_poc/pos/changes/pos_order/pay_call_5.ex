defmodule UniboExPoc.POS.Changes.PosOrder.PayCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :process_payment_lines, 2) do
      apply(module, :process_payment_lines, [changeset, context])
    else
