defmodule UniboExPoc.Inventory.Changes.StockMove.ActionCancelCall9 do
  use Ash.Resource.Change

  @impl true
  def change(changeset, _opts, context) do
    module_ref = "MoveLineIds"
    module = resolve_call_module(module_ref)
    if is_atom(module) and function_exported?(module, :release_reservation, 2) do
      apply(module, :release_reservation, [changeset, context])
    else
