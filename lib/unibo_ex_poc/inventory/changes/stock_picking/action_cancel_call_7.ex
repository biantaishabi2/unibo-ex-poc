defmodule UniboExPoc.Inventory.Changes.StockPicking.ActionCancelCall7 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :action_cancel, 2) do
      apply(module, :action_cancel, [changeset, context])
    else
