defmodule UniboExPoc.Inventory.Changes.StockPicking.ActionAssignCall2 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :action_assign, 2) do
      apply(module, :action_assign, [changeset, context])
    else
