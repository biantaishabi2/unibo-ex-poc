defmodule UniboExPoc.Inventory.Changes.StockQuant.UpdateAvailableQuantityCall1 do
  use Ash.Resource.Change

  @impl true
  def change(changeset, _opts, context) do
    module_ref = "Inventory"
    module = resolve_call_module(module_ref)
    if is_atom(module) and function_exported?(module, :invoke, 2) do
      apply(module, :invoke, [changeset, context])
    else
