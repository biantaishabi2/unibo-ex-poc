defmodule UniboExPoc.Inventory.Workflows.LandedCost.LandedCostLifecycleFlowWorkflow do
  @moduledoc """
  自动生成的工作流编排模块。
  ...
  def steps do
    [:create, :update, :button_validate]
  end

  @workflow_semantics_json ~S"""
{"steps":[{"idempotency_key":null,"next":["update"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"create"},{"idempotency_key":null,"next":["button_validate"],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"update"},{"idempotency_key":null,"next":[],"on_error":[],"retry":{"backoff_ms":0,"max_attempts":1},"step":"button_validate"}],"workflow":"landed_cost_lifecycle_flow"}
"""
  ...
  defp apply_step(record, step, params, opts) do
    ...
    case step do
      :create ->
        Ash.create(Ash.Changeset.for_create(LandedCost, :create, params), ash_opts)
      :update ->
