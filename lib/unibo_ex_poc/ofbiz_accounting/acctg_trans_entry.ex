defmodule UniboV4.Ofbiz.Accounting.AcctgTransEntry do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :acctg_trans_entry_type, UniboV4.Ofbiz.Accounting.AcctgTransEntryType do
      public? true
    end
    belongs_to :acctg_trans, UniboV4.Ofbiz.Accounting.AcctgTrans do
      public? true
    end
    ...
    belongs_to :settlement_term, UniboV4.Ofbiz.Accounting.SettlementTerm do
      public? true
    end
  end
