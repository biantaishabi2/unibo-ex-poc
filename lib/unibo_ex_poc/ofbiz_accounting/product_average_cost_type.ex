defmodule UniboV4.Ofbiz.Accounting.ProductAverageCostType do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_product_average_cost_type, UniboV4.Ofbiz.Accounting.ProductAverageCostType do
      public? true
