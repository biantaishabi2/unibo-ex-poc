defmodule UniboV4.Ofbiz.Accounting.PaymentGatewayConfigType do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :parent_payment_gateway_config_type, UniboV4.Ofbiz.Accounting.PaymentGatewayConfigType do
      public? true
      source_attribute :parent_type_id
    end
    has_many :sibling_payment_gateway_config_type, UniboV4.Ofbiz.Accounting.PaymentGatewayConfigType do
      public? true
    end
  end
