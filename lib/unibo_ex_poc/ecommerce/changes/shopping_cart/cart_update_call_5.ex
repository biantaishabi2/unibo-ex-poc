defmodule UniboExPoc.Ecommerce.Changes.ShoppingCart.CartUpdateCall5 do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_atom(module) and function_exported?(module, :remove_delivery_lines, 2) do
      apply(module, :remove_delivery_lines, [changeset, context])
    else
