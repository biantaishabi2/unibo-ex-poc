defmodule HospitalScheduling.Scheduling.MedicalStaffProfile do
  ...
  postgres do
    ...
    identity_index_names(
      unique_employee_department: "idx_scheduling_medical_staff_profiles_unique_employee_fd7e3b5a"
    )
  end
  ...
  actions do
    ...
    create :create do
      description(
        "Create Medical Staff Profile via Create. doc_url: graphql://contract/scheduling/create_scheduling_medical_staff_profile"
      )
    ...
    update :update do
      description(
        "Update Medical Staff Profile via Update. doc_url: graphql://contract/scheduling/update_scheduling_medical_staff_profile"
      )
