defmodule HospitalScheduling.Scheduling.ShiftPreference do
  ...
  actions do
    ...
    create :create do
      description(
        "Create Shift Preference via Create. doc_url: graphql://contract/scheduling/create_scheduling_shift_preference"
      )
      ...
      argument(:period_id, :uuid)
      change(manage_relationship(:period_id, :period, type: :append, on_lookup: :relate))
    end

    update :update do
      description(
        "Update Shift Preference via Update. doc_url: graphql://contract/scheduling/update_scheduling_shift_preference"
      )
