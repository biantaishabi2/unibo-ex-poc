defmodule HospitalScheduling.Scheduling.ShiftType do
  ...
  postgres do
    ...
    identity_index_names(
      unique_dept_shift_code: "idx_scheduling_shift_types_unique_dept_shift_code"
    )
  end
  ...
  actions do
    ...
    create :create do
      description(
        "Create Shift Type via Create. doc_url: graphql://contract/scheduling/create_scheduling_shift_type"
      )
    ...
    update :update do
      description(
        "Update Shift Type via Update. doc_url: graphql://contract/scheduling/update_scheduling_shift_type"
      )
