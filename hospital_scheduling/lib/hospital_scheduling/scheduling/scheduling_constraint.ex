defmodule HospitalScheduling.Scheduling.SchedulingConstraint do
  ...
  actions do
    ...
    create :create do
      description(
        "Create Scheduling Constraint via Create. doc_url: graphql://contract/scheduling/create_scheduling_scheduling_constraint"
      )
    ...
    update :update do
      description(
        "Update Scheduling Constraint via Update. doc_url: graphql://contract/scheduling/update_scheduling_scheduling_constraint"
      )
