defmodule HospitalScheduling.Scheduling.ShiftAssignment do
  ...
  postgres do
    ...
    identity_index_names(
      unique_period_employee_start:
        "idx_scheduling_shift_assignments_unique_period_employee_start"
    )

    identity_index_names(
      unique_version_req_employee_start:
        "idx_scheduling_shift_assignments_unique_version_req_em_834b770a"
    )
  end
  ...
  actions do
    ...
    create :create do
      description(
        "Create Shift Assignment via Create. doc_url: graphql://contract/scheduling/create_scheduling_shift_assignment"
      )
      ...
      change(
        manage_relationship(:requirement_id, :requirement, type: :append, on_lookup: :relate)
      )
    ...
    update :update do
      description(
        "Update Shift Assignment via Update. doc_url: graphql://contract/scheduling/update_scheduling_shift_assignment"
      )
...
解锁此排班. doc_url: graphql://contract/scheduling/unlock_scheduling_shift_assignment")
  ...
  identities do
    ...
    identity(:unique_version_req_employee_start, [
      :version_id,
      :requirement_id,
      :employee_id,
      :starts_at
