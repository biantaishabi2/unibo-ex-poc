defmodule HospitalScheduling.Scheduling.CoverageRequirement do
  ...
  postgres do
    ...
    identity_index_names(
      unique_period_date_shift_role:
        "idx_scheduling_coverage_requirements_unique_period_dat_461f704c"
    )
  end
  ...
  actions do
    ...
    create :create do
      description(
        "Create Coverage Requirement via Create. doc_url: graphql://contract/scheduling/create_scheduling_coverage_requirement"
      )
    ...
    update :update do
      description(
        "Update Coverage Requirement via Update. doc_url: graphql://contract/scheduling/update_scheduling_coverage_requirement"
      )
  ...
  identities do
    identity(:unique_period_date_shift_role, [
      :period_id,
      :requirement_date,
      :shift_type_id,
      :role_code
