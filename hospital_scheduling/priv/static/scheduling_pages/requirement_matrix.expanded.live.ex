defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @impl true
  def handle_event("action_start_generating", params, socket) do
    # UI action event name: action_start_generating
    socket = dispatch_backend("action_start_generating", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("batch_fill_requirements", params, socket) do
    # UI action event name: batch_fill_requirements
    socket = dispatch_backend("batch_fill_requirements", params, socket)
    {:noreply, socket}
  end
  ...
  @impl true
  def handle_event("save_requirements", params, socket) do
    # UI action event name: save_requirements
    socket = dispatch_backend("save_requirements", params, socket)
    {:noreply, socket}
  end
