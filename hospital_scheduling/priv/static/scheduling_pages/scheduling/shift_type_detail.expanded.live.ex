defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  @page_id "shift_type_detail"
  @page_title "Untitled Page"

  # status.keys preview (first ~40): editing, record, record.code, record.color, record.coverage_requirements, record.coverage_requirements[], record.coverage_requirements[].min_headcount, record.coverage_requirements[].notes, record.coverage_requirements[].priority, record.coverage_requirements[].required_lead_count, record.coverage_requirements[].required_skill_tags, record.coverage_requirements[].requirement_date, record.coverage_requirements[].role_code, record.coverage_requirements[].role_name, record.coverage_requirements[].target_headcount, record.duration_hours, record.enabled, record.end_time, record.is_night, record.name, record.sort_order, record.start_time
  ...
  @backend_load_selection "code color coverage_requirements { id min_headcount: minHeadcount notes priority required_lead_count: requiredLeadCount required_skill_tags: requiredSkillTags requirement_date: requirementDate role_code: roleCode role_name: roleName target_headcount: targetHeadcount } duration_hours: durationHours enabled end_time: endTime id is_night: isNight name sort_order: sortOrder start_time: startTime"
