defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): action_1_label, action_2_label, action_3_label, action_4_label, chart_1_title, chart_2_title
  ...
  @impl true
  def handle_event("quick_action_1", params, socket) do
    # UI action event name: quick_action_1
    socket = dispatch_backend("quick_action_1", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("quick_action_2", params, socket) do
    # UI action event name: quick_action_2
    socket = dispatch_backend("quick_action_2", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("quick_action_3", params, socket) do
    # UI action event name: quick_action_3
    socket = dispatch_backend("quick_action_3", params, socket)
    {:noreply, socket}
  end

  @impl true
  def handle_event("quick_action_4", params, socket) do
    # UI action event name: quick_action_4
    socket = dispatch_backend("quick_action_4", params, socket)
    {:noreply, socket}
  end
