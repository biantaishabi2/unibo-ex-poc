defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): shift_assignment, shift_assignment.ends_at, shift_assignment.is_locked, shift_assignment.notes, shift_assignment.source, shift_assignment.starts_at
