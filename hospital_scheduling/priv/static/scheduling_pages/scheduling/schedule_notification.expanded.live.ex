defmodule MyAppWeb.Pages.StitchGeneratedLive do
  ...
  # status.keys preview (first ~40): rows, rows[], rows[].end_date, rows[].generation_mode, rows[].notes, rows[].start_date, rows[].state, rows[].title, rows_empty, scheduling_period, scheduling_period.page, scheduling_period.total_pages
