...
defmodule HospitalScheduling.BDD.Generated.ActionSchedulingPeriodPublishUpdateTest do
  ...
  test "[BDD-SCHEDULING_SCHEDULING_PERIOD-SEED-action_scheduling_period_publish_update] SCHEDULING_SCHEDULING_PERIOD contract seed scenario" do
    ...
    # line 2: GIVEN given_seed_context id="action_scheduling_period_publish_update" module="SCHEDULING_SCHEDULING_PERIOD"
    ctx = HospitalScheduling.BDD.Instructions.V1.run_step!(ctx, :given, :given_seed_context, %{id: "action_scheduling_period_publish_update", module: "SCHEDULING_SCHEDULING_PERIOD"}, %{file: "/home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_scheduling_period_publish_update.dsl", line: 2, raw: "GIVEN given_seed_context id=\"action_scheduling_period_publish_update\" module=\"SCHEDULING_SCHEDULING_PERIOD\""}, 2)
