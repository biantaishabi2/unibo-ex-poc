# Generated by bdd_compiler from /home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_scheduling_period_start_generating_update.dsl. DO NOT EDIT.

defmodule HospitalScheduling.BDD.Generated.ActionSchedulingPeriodStartGeneratingUpdateTest do
  ...
  test "[BDD-SCHEDULING_SCHEDULING_PERIOD_START_GENERATING_UPDATE-SEED-action_scheduling_period_start_generating_update]" do
    ...
    ctx = %{
      run_id: run_id,
      scenario_id:
        "BDD-SCHEDULING_SCHEDULING_PERIOD_START_GENERATING_UPDATE-SEED-action_scheduling_period_start_generating_update"
    }
    ...
    ctx =
      HospitalScheduling.BDD.Instructions.V1.run_step!(
        ...
        :given_seed_context,
        %{
          id: "action_scheduling_period_start_generating_update",
          module: "SCHEDULING_SCHEDULING_PERIOD_START_GENERATING"
        },
        %{
          file:
            "/home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_scheduling_period_start_generating_update.dsl",
          line: 2,
          raw:
