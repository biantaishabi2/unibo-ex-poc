...
defmodule HospitalScheduling.BDD.Generated.ActionCoverageRequirementUpdateUpdateTest do
  ...
  test "[BDD-SCHEDULING_COVERAGE_REQUIREMENT_UPDATE_UPDATE-SEED-action_coverage_requirement_update_update]" do
    ...
    ctx = %{
      run_id: run_id,
      scenario_id:
        "BDD-SCHEDULING_COVERAGE_REQUIREMENT_UPDATE_UPDATE-SEED-action_coverage_requirement_update_update"
    }
    ...
    ctx =
      HospitalScheduling.BDD.Instructions.V1.run_step!(
        ...
        :given_seed_context,
        %{
          id: "action_coverage_requirement_update_update",
          module: "SCHEDULING_COVERAGE_REQUIREMENT"
        },
        %{
          file:
            "/home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_coverage_requirement_update_update.dsl",
          line: 2,
          raw:
