# Generated by bdd_compiler from /home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_solver_run_read_read.dsl. DO NOT EDIT.

defmodule HospitalScheduling.BDD.Generated.ActionSolverRunReadReadTest do
  ...
  test "[BDD-SCHEDULING_SOLVER_RUN_READ_READ-SEED-action_solver_run_read_read] SCHEDULING_SOLVER_RUN contract seed scenario" do
    ...
    ctx = HospitalScheduling.BDD.Instructions.V1.run_step!(ctx, :when, :when_execute_seed_contract, %{module: "SCHEDULING_SOLVER_RUN"}, %{file: "/home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_solver_run_read_read.dsl", line: 3, raw: "WHEN when_execute_seed_contract module=\"SCHEDULING_SOLVER_RUN\""}, 3)
    # line 4: THEN then_seed_contract_should_hold module="SCHEDULING_SOLVER_RUN"
    ctx = HospitalScheduling.BDD.Instructions.V1.run_step!(ctx, :then, :then_seed_contract_should_hold, %{module: "SCHEDULING_SOLVER_RUN"}, %{file: "/home/wangbo/document/unibo_ex_poc/hospital_scheduling/docs/bdd/action_solver_run_read_read.dsl", line: 4, raw: "THEN then_seed_contract_should_hold module=\"SCHEDULING_SOLVER_RUN\""}, 4)
    _ctx = ctx
    :ok
  end
